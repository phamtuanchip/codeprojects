        ...
        <tbody>
          ...
          colspan="2" height="100%"><table width="554" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <form id="form1" name="form1" method="post" action="">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="18%"><strong>Công nghệ sx </strong></td>
                        <td width="21%"><strong>Thị trường </strong></td>
                        <td width="11%"><strong>Thao tác </strong></td>
                      </tr>
                      <%dem=1%>
                  ...
                  <a href="TaoMoiDoanhNghiep.asp">Tạo mới doanh nghiệp</a>
			...
			%>
                  ...
                  <form action="thongkedanhsach_sanpham.asp" method="get" name="viewFrm" id="viewFrm">
                    <p>
