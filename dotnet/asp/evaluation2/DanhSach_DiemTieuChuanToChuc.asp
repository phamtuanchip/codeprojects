...
<p>
  ...
  TenTruyCap=session("ten")
	...
	strSQL = "SELECT *,TensanPham,TenHoiDong FROM ChiTietToChuc inner join SanPham on SanPham.MaSanPham = ChiTietToChuc.MaSanPham inner join HoiDong on HoiDong.MaHoiDong = ChiTietToChuc.MaHoiDong where HoiDong.MaDoanhNghiep = "&RSDoanhNghiep(0)
	RS.open strSQL, conn
%>
</p>
<table width="100%" border="1">
  <tr>
    <td><div align="center">Tên chi tiết tổ chức </div></td>
    <td><div align="center">T&ecirc;n sản phẩm </div></td>
    <td><div align="center">T&ecirc;n hội đồng</div></td>
    <td><div align="center">Alpha O</div></td>
  ...
  %>
  <tr>
    <td><div align="center"><%=RS("TenChiTietToChuc")%></td>
    <td> <%=RS("TenSanPham")%></td>
    <td><div align="center"><%=RS("TenHoiDong")%></div></td>
    <td>&nbsp;<div align="center"><%=RS("AlphaO")%></div></td>
