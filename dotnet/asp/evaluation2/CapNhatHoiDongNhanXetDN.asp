                ...
                <tr>
				  ...
				  <!-- InstanceBeginEditable name="noidungcuanguoidung " -->
					...
					On error resume next
						...
						NoiDung=Request.Form("txtContent")
						'dim rsDN
					 	'set rsDN =server.CreateObject("adodb.recordset")
						'Dim MaHoiDong
						Sql="Select count(*) From HoiDongNhanXetDoanhnghiep where MaDoanhNghiep=" & MaDoanhNghiep & " and MaSanPham=" & MaSanPham & " and MaHoiDong=" & MaHoiDong
						Rs.open Sql,conn
						if Cint(Rs(0))>0  then
							'Response.Write("Cos rooif")	
							SqlUpdate="Update HoiDongNhanXetDoanhnghiep set NhanXet=N'" & NoiDung & "' where MaDoanhNghiep=" & MaDoanhNghiep & " and MaSanPham=" & MaSanPham & " and MaHoiDong=" & MaHoiDong
							conn.execute SqlUpdate
							ThongBao="Bạn đã sửa thành công phần nhận xét về doanh nghiệp.  Bạn hãy nhấn" & "<a href='DrawAppletMain.asp'>" & " vào đây " &"</a>" & "để quay trở lại trang đánh giá doanh nghiệp"
							'Response.Redirect("HoiDongNhanXetDN.asp?ThongBao=" & ThongBao)	
							Response.Write("<Br>")
							Response.Write(ThongBao)
						else
							SqlInsert="Insert into HoiDongNhanXetDoanhnghiep Values(N'" & MaDoanhNghiep & "',N'" & MaSanPham & "',N'" & MaHoiDong & "',N'" & NoiDung & "')"
							conn.execute SqlInsert
							ThongBao="Bạn đã thêm mới thành công phần nhận xét về doanh nghiệp. Bạn hãy nhấn" & "<a href='DrawAppletMain.asp'>" & " vào đây " &"</a>" & "để quay trở lại trang đánh giá doanh nghiệp"
							'Response.Redirect("HoiDongNhanXetDN.asp?ThongBao=" & ThongBao)
							Response.Write("<Br>")
							'Response.Write(MaDoanhNghiep)
							'Response.Write(MaSanPham)
							'Response.Write(MaHoiDong)
							'Response.Write(NoiDung)
							Response.Write(ThongBao)
						end if
