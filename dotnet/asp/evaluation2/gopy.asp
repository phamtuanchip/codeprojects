        ...
        <tbody>
          ...
          colspan="2" height="100%"><table width="554" border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <form id="gopy" name="gopy" method="post" action="">
				    <table width="100%" border="1" align="center">
                      <tr>
                        <td width="206">Tên của bạn </td>
                        <td width="332"><input name="textfield" type="text" size="30" /></td>
                      </tr>
                      <tr>
                        <td>Bạn muốn góp ý về: </td>
                        <td><input name="textfield2" type="text" size="30" /></td>
                      </tr>
                      <tr>
                        <td>Nội dung chi tiết </td>
                        <td><textarea name="textfield22" cols="25" rows="5"></textarea></td>
                      </tr>
                      <tr>
                        <td colspan="2">Chúng tôi có thể liên lạc lại với bạn qua: </td>
                      </tr>
                      <tr>
                        <td>Thư điện tử </td>
                        <td><input name="textfield222" type="text" size="30" /></td>
                      </tr>
                      <tr>
                        <td>Địa chỉ </td>
                        <td><textarea name="textfield2222" cols="25" rows="5"></textarea></td>
                      </tr>
                      <tr>
                        <td>Số điện thoại </td>
                        <td><input name="textfield22222" type="text" size="30" /></td>
                      </tr>
                    </table>
                      </form>
