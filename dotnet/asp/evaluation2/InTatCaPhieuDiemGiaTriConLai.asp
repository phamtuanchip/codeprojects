...
%>
				 ...
				 <center><span class="style3">PHIẾU CHO ĐIỂM GIÁ TRỊ CÒN LẠI CỦA THIẾT BỊ</span><P></center> 	
				  Hội đồng: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><%=RSHD(1)%></b><br />
Doanh nghiệp: &nbsp;<%="<b>" & Rs(0) & "</b>"  %>
<form id="form1" name="form1" method="post" >
	...
	Dim rsinall
	set rsinall = Server.CreateObject("ADODB.Recordset")
	Dim sqlinall
	MaDoanhNghiep=Session("ma_dn")
	'MaThietBi=Request.Form("MaThietBi"&i)
	sqlinall = "SELECT * from ThietBi where MaThietBi=" & RSTB(0) & " and MaDoanhNghiep=" & MaDoanhNghiep 
	'Response.Write(sqlinall)
	rsinall.Open sqlinall,conn
%>
                      ...
                      ></tr>
				      <tr height="20">
				        <td><div align="center">Năng xuất thực tế N%</div></td>
                          <td >&nbsp;<%=rsinall("N")%></td
                      ></tr>
				      <tr height="20">
