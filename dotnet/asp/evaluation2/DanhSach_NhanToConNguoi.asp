...
Dim p
	...
	sqlStr = "SELECT * FROM DSNTConNguoiView WHERE MaDoanhNghiep="&Session("ma_dn")
		'Phan trang--------------------------------------------------------------------------------------
		RS.CursorLocation = 3
		'3 nhan vien 1 trang
		RS.PageSize =10
		RS.Open sqlStr, conn
			...
			%>
			<h3 align="center">Danh sách nhân tố con người</h3>
<table width="100%" border="1" cellpadding="5" align="center">
			...
			' rs.Open;
			%>     </p>     <form action="DanhSach_NhanToConNguoi.asp" method="get" name="viewFrm" id="viewFrm">
