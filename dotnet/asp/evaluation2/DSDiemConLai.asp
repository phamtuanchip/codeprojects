...
<title>Danh sách giá trị còn lại của thiết bị</title>
<!-- InstanceEndEditable -->
        ...
        <tbody>
          ...
          colspan="2" height="100%"><table width="554" border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <%
				  	strSQL = "select * from ThietBi where MaDoanhNghiep="&Session("ma_dn")&""
					RS.open strSQL, conn
					dim i
					i=1
				  %>
				  <input type="button" value="Quay lại" onclick="history.back()" /><br />
<br />

				  <table width="100%" border="1">
                    <tr>
                      <th width="5%" scope="col">TT</th>
                      <th width="19%" scope="col">Tên thiết bị </th>
                      <th width="17%" scope="col">Nơi SX </th>
                      <th width="13%" scope="col">Năm sử dụng </th>
                      <th width="7%" scope="col">T%</th>
                      <th width="8%" scope="col">H%</th>
                      <th width="6%" scope="col">N%</th>
                      <th width="6%" scope="col">C%</th>
                      <th width="5%" scope="col">k</th>
                      <th width="14%" scope="col">Giá trị Z% </th>
                    </tr>
                    <%
						while not (RS.eof)
					%>
					<tr>
                      ...
                      <td><%=RS("TenThietBi")%></td>
                      <td><div align="center"><%=RS("NoiSanXuat")%></div></td>
                      <td><%=RS("NamSanXuat")%></td>
                      <td><%=RS("T")%></td>
                      <td><%=RS("H")%></td>
                      <td><%=RS("N")%></td>
                      ...
                      <td><%=RS("k")%></td>
                      <td>
			<%=RS("k")/(RS("Kt")+RS("Kh")+RS("Kn")+RS("Kc"))*(RS("Kt")*RS("T")+RS("Kh")*RS("H")+RS("Kn")*RS("n")+RS("Kc")*RS("C"))
						%>
					  </td>
					  <%
					  	RS.movenext
