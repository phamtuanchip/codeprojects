...
height="70"><table cellspacing="0" cellpadding="0" border="0">
  ...
  <%
	if  (Session("ma_dn")=0) then
		Session("ma_dn")=Request.Form("chondn")
	end if
	if  not Session("ma_hd")>0 then 
		Session("ma_hd")=Request.Form("chonhd")
	end if
	if not Session("ma_sp")>0 then
		Session("ma_sp")=Request.Form("chonsp")
	end if
	if session("ma_sp") <= 0 then 
		Response.Redirect("nguoidungdangnhap.asp")
	end if
%>
  </p>
                  <fieldset >
				 ...
				 %>
                  ...
                  <ul>
                    <li><a href="Nhap_alphat.asp">Nhập hệ số alpha T </a></li>
                    <li><a href="Nhap_alphaH.asp">Nhập hệ số alpha H </a></li>
                    <li><a href="Nhap_alphai.asp">Nhập hệ số alpha I </a></li>
                    <li><a href="Nhap_alphao.asp">Nhập hệ số alpha O</a></li>
                    <li><a href="PhieuDiemSanPham.asp">Phiếu điểm sản phẩm</a></li>
                    <li><a href="PhieuDiemSanPhamTheoCongDoanSanXuat.asp">Phiếu điểm sản phẩm theo công đoạn sản xuất </a></li>
                    <li><a href="PhieuDiemNhapGiaTriConLaiCuaThietBi.asp"></a><a href="PhieuChoDiemTrinhDo.asp">Phiếu điểm thành phần công nghệ theo trình độ hiện đại</a></li>
                    <li><a href="nhap_diemcongnghetheohieuqua.asp">Phiếu điểm thành phần công nghệ theo hiệu quả</a></li>
                    <li><a href="PhieuDiemTPCongNghe.asp">Phiếu điểm thành phần công nghệ theo công đoạn</a></li>
                    <li><a href="PhieuChoDiemTPConNguoiTheoCongDoan.asp">Phiếu điểm thành phần con người theo công đoạn</a></li>
                    <li><a href="PhieuDiemNhapGiaTriConLaiCuaThietBi.asp">Phiếu điểm giá trị còn lại của thiết bị</a></li>
                  </ul>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p>
