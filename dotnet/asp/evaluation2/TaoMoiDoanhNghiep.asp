...
<title>Tạo mới doanh nghiệp</title>
<!-- InstanceEndEditable -->
...
<%
	...
	if(myDNSession>0) then
		Response.Write("Bạn không có quyền tạo mới doanh nghiệp.Xin vui lòng quay lại")
	else
%>
	...
	<h3 align="center">Tạo mới Doanh Nghiệp</h3>
	<p align="center"><a>Mời bạn điền đầy đủ thông tin và ấn vào nút Tạo mới để hoàn tất việc tạo mới Doanh Nghiệp hoặc ấn vào nút Bỏ qua để xóa các thông tin đã điền và nhập lại.</a></p>
	<%
	Dim errorStr
	...
	%>
	<p align="center"><a>Để xem danh sách các Doanh Nghiệp, mời bạn <a href="http://server/ghep/XemDanhSach.asp?page=2&loai=DoanhNghiep">ấn vào đây.</a></a></p>
	<form action="Tao_Moi.asp" method="post" name="form1" id="form1" onsubmit="MM_validateForm('TenDoanhNghiep','','R','DiaChi','','R','Email','','NisEmail','NamThanhLap','','NisNum');return document.MM_returnValue">
	  <table width="95%" border="0" align="center">
		<tr>
		  <td width="27%" align="right">T&ecirc;n doanh nghi&#7879;p</td>
		  <td width="73%"><input name="TenDoanhNghiep" type="text" id="TenDoanhNghiep" value="<%=Request.QueryString("TenDoanhNghiep")%>" size="60" /></td>
		</tr>
		<tr>
		  <td align="right">Ch&#7913;c n&#259;ng</td>
		  <td><textarea name="ChucNang" cols="47" rows="4" id="ChucNang"><%=Request.QueryString("ChucNang")%></textarea></td>
		</tr>
		<tr>
		  <td align="right">&#272;&#7883;a ch&#7881;</td>
		  <td><input name="DiaChi" type="text" id="DiaChi" value="<%=Request.QueryString("DiaChi")%>" size="60" /></td>
		</tr>
		<tr>
		  <td align="right">S&#7889; &#273;i&#7879;n tho&#7841;i - Fax</td>
		  <td><input name="SoDienThoai_Fax" type="text" id="SoDienThoai_Fax" value="<%=Request.QueryString("SoDienThoai_Fax")%>" size="60" /></td>
		</tr>
		<tr>
		  <td align="right">Email</td>
		  <td><input name="Email" type="text" id="Email" value="<%=Request.QueryString("Email")%>" size="60" /></td>
		</tr>
		<tr>
		  <td align="right">Website</td>
		  <td><input name="Website" type="text" id="Website" value="<%=Request.QueryString("Website")%>" size="60" /></td>
		</tr>
		<tr>
		  <td align="right">N&#259;m th&agrave;nh l&#7853;p</td>
		  <td><input name="NamThanhLap" type="text" id="NamThanhLap" value="<%=Request.QueryString("NamThanhLap")%>" size="60" />
	...
	<h3 align="center">Danh sách các Doanh Nghiệp:</h3>
			<table width="100%" border="1" cellpadding="5">
				...
				' rs.Open;
				%>     </p>     <form action="TaoMoiDoanhNghiep.asp" method="get" name="viewFrm" id="viewFrm">
