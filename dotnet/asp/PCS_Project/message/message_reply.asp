    ...
    <tr>
      <td colspan="2" background="../images/bg01.gif"><table width="100%" height="57" border="0" cellpadding="0" cellspacing="0">
        <tr valign="top">
          ...
          <td width="79%"><table width="98%"  border="0" cellpadding="00" cellspacing="0">
            ...
            <%// cac bien
    	      var  tendangnhap=Session("username");
	         	   madangnhap=Session("ma_nv") ;
	        	   tennhanvien=Session("ten_nv");
				   manguoinhan=Request.QueryString("traloicho")
			%>
          ...
          <fieldset>
		  <legend align="center">Chào mừng: <%=tennhanvien%>&nbsp; đến với phần trả lời tin nhắn!</legend>
		  ...
		  <%rs3.Close;rs4.Close;rs5.Close;%>
		        <table width="100%"  border="1" cellpadding="00" cellspacing="0" bgcolor="#009ACE" rules="none">
                  <tr> 
                    <%rs=oConn.Execute("select ten_nv from NHANVIEN where ma_nv='"+madangnhap+"'") ;%>
                    <td width="22%">Tên người gửi</td>
                    <td width="17%"><input name="tennguoigui" type="text" readonly="1" id="tennguoigui" value="<%=rs("ten_nv")%>" size="20"></td>
                    <%rs=oConn.Execute("select ten_nv from NHANVIEN where ma_nv='"+manguoinhan+"'") ;%>
                    <td width="24%">Tên người nhận</td>
                    <td width="37%"><input name="tennguoinhan" type="text" readonly="1" id="tennguoinhan" value="<%=rs("ten_nv")%>" size="20"></td>
                  </tr>
                  <tr> 
                    <td>Mã người gửi</td>
                    <td><input name="manguoigui" type="text"id="manguoigui" value="<%=madangnhap%>" size="10"  readonly="1"></td>
                    <td>Mã người nhận</td>
                    <td><input name="manguoinhan"type="text" id="manguoinhan" value="<%=manguoinhan%>" size="10" readonly="1"></td>
                  </tr>
                  <tr> 
                    <td>Chủ đề </td>
                  ...
                  <tr> 
                    <td>&nbsp;</td>
                    <td><input type="reset" name="Reset"  tabindex="5"value="Làm lại" ></td>
