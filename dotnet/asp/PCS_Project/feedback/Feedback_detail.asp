...
<p>&nbsp;</p>     
          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
              ...
              <!--#include file = "../Connections/Connection.inc"-->
              <%
			   		rs = oConn.Execute("Select * from GOPY where ma_gop_y ='" +  Request.QueryString("magopy") + "'");
			   %>
              <form name="form1" method="post" action="Read_feedback.asp">
                <table width="100%"  border="1" cellpadding="5" cellspacing="0" class="Link">
                  <tr bgcolor="#CCCCCC">
                    <td colspan="2"><div align="center" class="Folder">Nội dung chi tiết</div></td>
                  </tr>
                  <tr>
                    <td><div align="left" class="Normal style2 style5">Ti&ecirc;u &#273;&#7873;</div></td>
                    <td><%=rs("tieu_de")%></td>
                  </tr>
                  <tr>
                    <td><div align="left" class="Normal style2 style5">Nội dung </div></td>
                    <td><%=rs("noi_dung_gop_y")%></td>
                  </tr>
                  <tr>
                    <td><div align="left" class="Normal style1 style2 style3">Ng&#432;ời gửi</div></td>
                    <td><%=rs("nguoi_gop_y")%></td>
                  </tr>
                  <tr>
                    <td><div align="left" class="Normal style2 style5">Email</div></td>
                    <td><%=rs("email")%></td>
                  </tr>
                  <tr>
                    <td><div align="left" class="Normal style1 style4">Ngày</div></td>
                    <td><%=rs("ngay_gop_y")%></td>
                  </tr>
                  <tr>
                    <td width="18%"><div align="left"></div></td>
                    <td width="82%"><div align="right">
                        <input name="magopy"  type="hidden" id="magopy" value="<%=rs("ma_gop_y")%>">
                        <input name="Submit" type="submit" class="VoteButton" value="Submit">
                    </div></td>
                  </tr>
                </table>
              </form>
