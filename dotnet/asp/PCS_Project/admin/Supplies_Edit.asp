...
<p>&nbsp;</p>     
          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
              ...
              <!--#include file = "../Connections/Connection.inc"-->
              <%	
				rs = oConn.Execute("Select * from NHACUNGCAP where ma_nha_cc ='" + Request.QueryString("macc") + "'");
			  %>
              <form action="SaveEditSupplies.asp" method="post" name="edit" id="edit">
                <table rules="none" width="564" border="1" cellpadding="5" cellspacing="0" class="Link">
                  <tr bgcolor="#CCCCCC">
                    <td height="37" colspan="2"><div align="center" class="Folder">S&#7917;a th&ocirc;ng tin nh&agrave; cung c&#7845;p</div></td>
                  </tr>
                  <tr>
                    <td width="144">M&atilde; nh&agrave; cung c&#7845;p</td>
                    <td width="388"><input name="mancc" type="text"  value="<%=rs("ma_nha_cc")%>" size="15"></td>
                  </tr>
                  <tr>
                    <td>T&ecirc;n nh&agrave; cung c&#7845;p</td>
                    <td><input name="tenncc" type="text" id="tenncc" value="<%=rs("ten_nha_cc")%>">
                    </td>
                  </tr>
                  <tr>
                    <td>&#272;&#7883;a ch&#7881;</td>
                    <td><input type="text" name="diachi" value="<%=rs("dia_chi_ncc")%>"></td>
                  </tr>
                  <tr>
                    <td>Qu&#7889;c t&#7883;ch</td>
                    <td><input name="quoctich" type="text" id="quoctich" value="<%=rs("quoc_tich_ncc")%>">
                    </td>
                  </tr>
                  <tr>
                    <td>&#272;i&#7879;n tho&#7841;i</td>
                    <td><input name="dienthoai" type="text" id="dienthoai" value="<%=rs("dien_thoai_ncc")%>"></td>
                  </tr>
                  <tr>
                    <td height="35">Email</td>
                    <td><input name="email" type="text" id="email" value="<%=rs("email_ncc")%>"></td>
                  </tr>
                  <tr>
                    <td height="35">Ghi ch&uacute;</td>
                    <td><textarea name="ghichu" cols="50" rows="2" id="ghichu"><%=rs("ghi_chu")%>
              </textarea></td>
                  </tr>
                  <tr>
