...
<p>&nbsp;</p>     
	...
	rs.CursorLocation = 3;
	 //4 nhan vien 1 trang
	rs.PageSize = 10;
	rs.Open("select * from LOAITHIETBI", oConn);
...
%>
                ...
                <form name="form1" method="post" action="">
                  <table width="100%"  border="1" cellspacing="0" class="Link">
                    <tr>
                      <td colspan="5"><div align="center" class="Folder">Danh mục th&#7875; loại thiết b&#7883;</div></td>
                    </tr>
                    <tr bgcolor="#CCCCCC">
                      <td width="9%"><div align="center">Stt</div></td>
                      <td width="41%"><div align="center">Loại thiết b&#7883;</div></td>
                      <td width="25%"><div align="center">K&yacute; hiệu</div></td>
                    ...
                    <tr>
                      ...
                      <td><div align="center"><a href="Categories_details.asp?matl=<%=rs("ma_loai_tb")%>" class="ShowNext"> <%=rs("ten_loai_tb")%> </a></div></td>
                      <td><div align="center"> <%=rs("ky_hieu")%> </div></td>
                      <td width="13%"><div align="center"><a href="Categories_Edit.asp?matl=<%=rs("ma_loai_tb")%>" class="ShowNext">Sửa</a></div></td>
                      <td width="12%"><div align="center"><a href=javascript:del("<%=rs("ma_loai_tb")%>") class="ShowNext">Xóa</a></div></td>
                    </tr>
                    <%stt = stt +1;
					rs.MoveNext;} 
					%>
	...
	%>
                <p></p>
                <form name="viewFrm" method="get" action="Categories.asp">
                  <p>
                    <input type="hidden" name="page" value="<%=rsCurrentPage%>"/>
                  </p>
                </form>
                <form action="Delete_Cate.asp" name="delFrm">
                  <input type="hidden" name="option" value="delete" />
                  <input type="hidden" name="matl" >
                </form>
                <%	
