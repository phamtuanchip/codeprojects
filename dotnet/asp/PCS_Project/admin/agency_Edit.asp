          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
              ...
              <td width="96%" valign="top"><!-- InstanceBeginEditable name="nhom_thietke" -->
                <p>
                  <!--#include file = "../Connections/Connection.inc"-->
                  <%rs = oConn.Execute("select * from HANGSANXUAT where ma_hang_sx =" + Request.QueryString("masx"))%>
                </p>
                <form name="form1" method="post" action="SaveEdit_agency.asp">
                  <table width="100%"  border="1" cellspacing="0" class="Link">
                    <tr>
                      <td colspan="2"><div align="center" class="Folder">Chi ti&#7871;t nh&agrave; sản xuất</div></td>
                    </tr>
                    <tr>
                      <td width="26%">M&atilde; nh&agrave; sản xuất</td>
                      <td width="74%"><input name="madv" type="text" id="madv" value="<%=rs("ma_hang_sx")%>" size="10"></td>
                    </tr>
                    <tr>
                      <td>T&ecirc;n nh&agrave; sản xuất</td>
                      <td><input name="tendv" type="text" id="tendv" value="<%=rs("ten_hang_sx")%>"></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
