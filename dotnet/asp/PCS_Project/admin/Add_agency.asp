          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
              ...
              <td width="96%" valign="top"><!-- InstanceBeginEditable name="nhom_thietke" -->
                <form action="SaveAddagency.asp" method="post" name="" id="">
                  <table rules="none" width="564" border="1" cellspacing="0">
                    <tr>
                      <td colspan="2"><div align="center" class="Folder">Th&ecirc;m h&atilde;ng sản xuất</div></td>
                    </tr>
                    <tr>
                      <td width="128">T&ecirc;n h&atilde;ng</td>
                      <td width="420"><input name="tenhang" type="text" id="tenhang">
                      </td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td><input name="submit" type="submit" class="VoteButton" value="Thêm">
