      ...
      <td colspan="2" background="../images/bg01.gif"><table width="100%" height="57" border="0" cellpadding="0" cellspacing="0">
        <tr valign="top">
          ...
          <td width="79%"><table width="98%"  border="0" cellpadding="00" cellspacing="0">
            ...
            <fieldset>
			<legend align="center">Chào mừng:<%=Session("ten_nv")%>; Bạn muốn lập phiếu mới với khách hàng quen?</legend>
				<center>Xin mời nhập tên khách hàng để tìm kiếm</center>  
            <form action="search_customers_result.asp" method="post" name="timkiem" id="timkiem">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="62%"><div align="right">
                    <input name="tenkhachhang" type="text" id="tenkhachhang" size="45" value="Điền tên khách hàng..."  onFocus="this.value=''">                          
                  </div></td>
                <td width="38%" nowrap><div align="right">
                    <input type="submit" name="Submit" value="Tìm">
                    <input type="reset" name="Reset" value="Làm lại" >
                    <input type="button" name="Button" value="Tìm nâng cao!"  onClick="window.location='search_customers_adv.asp'">
				    </div></td>
                </tr>
              </table>
			  <center>Bạn cũng có thể lập phiếu mới hoàn toàn bằng việc bấm vào đây đường link bên dưới:<br>
			  <a href="insert_new_ticket.asp"><strong>Lập mới hoàn toàn!<%=">>>>"%></strong></a>
			  </center>
            </form>
			</fieldset>	  
		   <!-- InstanceEndEditable -->
