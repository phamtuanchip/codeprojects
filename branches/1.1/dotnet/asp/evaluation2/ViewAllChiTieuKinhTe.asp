...
<title>Xem các chỉ tiêu kỹ thuật</title>
<!-- InstanceEndEditable -->
...
<p>
  <%
	strSQL = "SELECT dbo.TieuChuanKinhTe.* FROM dbo.TieuChuanKinhTe INNER JOIN dbo.SanPham ON dbo.TieuChuanKinhTe.MaSanPham = dbo.SanPham.MaSanPham WHERE (dbo.SanPham.MaDoanhNghiep ="&Session("ma_dn")&") order by Nam "
	RS.open strSQL, conn
%>
</p>
<table width="100%"  border="1">
  ...
  %>
  <tr>
    <td width="29%"><div align="left"><strong>N&#259;m</strong></div></td>
    <td width="71%"><%=RS("Nam")%></td>
  </tr>
  <tr>
    <td><div align="left"><strong>Tổng doanh thu </strong></div></td>
    <td><%=RS("Q")%></td>
    </tr>
  <tr>
    <td><div align="left"><strong>Tổng s&#7889; L&#272;</strong></div></td>
    <td><%=RS("T")%></td>
    </tr>
  <tr>
    <td><div align="left"><strong>Lợi nhuận</strong></div></td>
    <td><%=RS("P")%></td>
    </tr>
  <tr>
    <td><div align="left"><strong>Gi&aacute; tr&#7883; tài sản còn lại</strong></div></td>
    <td><%=RS("K2")%></td>
    </tr>
  <tr>
    <td><div align="left"><strong>Gi&aacute; tr&#7883; gia t&#259;ng</strong></div></td>
    <td><%=RS("Va")%></td>
    </tr>
  <tr>
    <td><div align="left"><strong>S<sub>1</sub></strong></div></td>
    <td><%=RS("Q")/RS("T")%></td>
    </tr>
  <tr>
    <td><div align="left"><strong>P<sub>2</sub></strong></div></td>
    <td><%=RS("P")/RS("T")%></td>
    </tr>
  <tr>
    <td><div align="left"><strong>S<sub>3</sub></strong></div></td>
    <td><%=RS("Q")/RS("K2")%></td>
    </tr>
  <tr>
    <td><div align="left"><strong>S<sub>4</sub></strong></div></td>
    <td><%=RS("Q")/RS("K2")*100%></td>
    </tr>
  <tr>
    <td><div align="left"><strong>S<sub>5</sub></strong></div></td>
    <td><%=RS("Va")/RS("T")%></td>
    </tr>
  <%
  	RS.movenext
