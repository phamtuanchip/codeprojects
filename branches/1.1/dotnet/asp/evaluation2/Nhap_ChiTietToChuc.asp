...
//function isNumber(formchitiettochuc) {
   // var str = formchitiettochuc.tencttc.value;
   // var re = /^[a-zA-Z]/;
  //  str = str.toString( );
  //  if (!str.match(re)) {
     //   alert("Tên chi tiết tổ chức không được nhập dạng số");
     //   return false;
  //  }
   // return true;
//}
function istxtAlphaIEmpty(formchitiettochuc) {
      if ( 	formchitiettochuc.alphao.value == ""){
...
function isNumberAlphaI(formchitiettochuc) {
    var str = formchitiettochuc.alphao.value;
    var re = /^[0-9]/;
    str = str.toString( );
    if (!str.match(re)) {
...
%>
<center><font face="Arial, Helvetica, sans-serif" color="#006633" size="4">Nhập chi tiết tổ chức</font></center><br>
<table align="center">
<tr>
...
<tr>
<td align="center">Để xem danh sách Chi Tiết Tổ Chức . Xin hãy nhấn <a href="DanhSach_ChiTietToChuc.asp">vào đây</a></td>
</tr>

</table>
<form action="XuLy_NhapChiTietToChuc.asp" method="post" name="formchitiettochuc" id="formchitiettochuc" onsubmit="return validateForm(this)">
  <table width="100%" border="0" align="center">
    <tr>
      <td width="101">Tên chi tiết tổ chức</td>
      <td width="403"><textarea name="tencttc" cols="50" id="tencttc"></textarea></td>
    </tr>
    <tr>
      <td>Tên sản phẩm</td>
      <td><select name="slSanPham"  onchange="window.location='Nhap_ChiTietToChuc.asp?MaSanPham='+this.value">
	...
	<tr>
      <td>Alpha O</td>
      <td><input type="text" name="alphao" value="0" readonly="1" onblur="if ((this.value>=1)||(this.value<0)){alert('Điểm Alpha O không được nhỏ hơn 0 hoặc lớn hơn 1'); this.value='0';};">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      (Alpha O mặc định khi tạo ra bằng 0 ) </td>
    </tr>
    <tr>
      <td>Ghi chú </td>
      <td><textarea name="ghichu" id="ghichu" rows="10" cols="50"></textarea></td>
    </tr>
	 </table>
	 <table align="center">
    <tr>
