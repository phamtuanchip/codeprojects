...
<title>Nhập các chỉ tiêu kỹ thuật</title>
<!-- InstanceEndEditable -->
          ...
          colspan="2" height="100%"><table width="554" border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <%
					...
					strSP = "select TenSanPham, MaSanPham from sanpham where madoanhnghiep="&Session("ma_dn")&""
					Rs3.open strSP, conn
					
					dim RS4
					Set RS4 = Server.CreateObject("ADODB.Recordset")
					strHD = "select MaHoiDong, TenHoiDong from HoiDong where MaDoanhNghiep="&Session("ma_dn")&""
					RS4.open strHD, conn
				 ...
				 %>
				  ...
				  <p>&nbsp;</p>
				  <p>
				  <div align="center"><strong>NHẬP CÁC CHỈ TIÊU KỸ THUẬT </strong></div>
				  </p>
				  <form action="CapNhatChiTieuKyThuat.asp" method="post" name="form1" id="form1" onsubmit="MM_validateForm('Q','','RisNum','BetaT','','RinRange0:1','BetaH','','RinRange0:1','BetaI','','RinRange0:1','BetaO','','RinRange0:1','Nam','','RinRange1980:2020');return document.MM_returnValue">
				    <table width="100%" border="1">
                      <tr>
                        <td colspan="2">T&ecirc;n hội đồng 
						<select name="MaHoiDong">
						<%while not (RS4.eof)%>
                      ...
                      <tr>
                        <td colspan="2">Tên sản phẩm
                          <select name="MaSanPham">
                            <%while not (Rs3.eof)%>
                            <option value="<%=Rs3(1)%>"><%=Rs3(0)%></option>
                            <%
								Rs3.movenext
								wend
							%>
                      ...
                      <tr>
                        <td><div align="right">Giá trị tổng doanh thu (Q) </div></td>
                        <td><input name="Q" type="text" id="Q" /></td>
                      </tr>
                      <tr>
                        <td><div align="right"><font face="Symbol" size="+1">b</font><sub>T</sub> </div></td>
                        <td><input name="BetaT" type="text" id="BetaT" /></td>
                      </tr>
                      <tr>
                        <td><div align="right"><font face="Symbol" size="+1">b</font><sub>H</sub></div></td>
                        <td><input name="BetaH" type="text" id="BetaH" /></td>
                      </tr>
                      <tr>
                        <td><div align="right"><font face="Symbol" size="+1">b</font><sub>I</sub></div></td>
                        <td><input name="BetaI" type="text" id="BetaI" /></td>
                      </tr>
                      <tr>
                        <td><div align="right"><font face="Symbol" size="+1">b</font><sub>O</sub></div></td>
                        <td><input name="BetaO" type="text" id="BetaO" /></td>
                      </tr>
                      <tr>
                        <td><div align="right">N&#259;m </div></td>
