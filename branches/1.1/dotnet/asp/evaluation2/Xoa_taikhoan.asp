        ...
        <tbody>
          ...
          colspan="2" height="100%"><table width="554" border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <%
				  	if (len(Request.QueryString("tendn"))>0) then
						conn.execute " delete [guest] where tentruycap=N'"+Request.QueryString("tendn")+"'"
						conn.execute " delete [users] where tentruycap=N'"+Request.QueryString("tendn")+"'"
