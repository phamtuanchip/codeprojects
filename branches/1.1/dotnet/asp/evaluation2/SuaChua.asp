...
<%
	Dim RS1,RS2,RS3,RS4,RS5,RS6,RS7,RS8
	...
	str1="select * from ChiTietThongTin"
	str2="select * from ChiTietToChuc"
	str3="select * from DiemTieuChuanMoiTruong"
	str4="select * from HieuQuaCongNghe_KyThuat"
	str5="select * from HieuQuaCongNghe_ThongTin"
	str6="select * from HieuQuaCongNghe_ToChuc"
	str7="select * from NhanToConNguoi"
	str8="select * from NhanToMoiTruong"
	RS1.Open str1,conn
	RS2.Open str2,conn
	RS3.Open str3,conn
	RS4.Open str4,conn
	...
	RS8.Open str8,conn
%>
<center><font face="Arial, Helvetica, sans-serif" color="#006633" size="4">Chọn thông tin cần sửa</font></center><br>
<p>
<a href="Sua_DiemTieuChuanMoiTruong.asp?MaNhanToMoiTruong=<%=RS3("MaNhanToMoiTruong")%>">Sửa điểm tiêu chuẩn môi trường</a><br>
<a href="Sua_DiemTieuChuanMoiTruong.asp?MaNhanToMoiTruong=<%=RS3("MaNhanToMoiTruong")%>">Sửa điểm tiêu chuẩn môi trường</a><br>
<a href="Sua_HieuQuaCongNgheKyThuat.asp?MaHieuQuaCongNghe_KyThuat=<%=RS4("MaHieuQuaCongNghe_KyThuat")%>">Sửa hiệu quả công nghệ kỹ thuật</a><br>
<a href="Sua_HieuQuaCongNgheThongTin.asp?MaHieuQuaCongNghe_ThongTin=<%=RS5("MaHieuQuaCongNghe_ThongTin")%>">Sửa hiệu quả công nghệ thông tin</a><br>

<a href="Sua_HieuQuaCongNgheToChuc.asp?MaHieuQuaCongNghe_ToChuc=<%=RS6("MaHieuQuaCongNghe_ToChuc")%>">Sửa hiệu quả công nghệ tổ chức</a><br>
<a href="Sua_NhanToConNguoi.asp?MaNhanToConNguoi=<%=RS7("MaNhanToConNguoi")%>">Sửa nhân tố con người</a><br>
<a href="Sua_NhanToMoiTruong.asp?MaNhanToMoiTruong=<%=RS8("MaNhanToMoiTruong")%>">Sửa nhân tố môi trường</a><br>
<a href="Sua_ChiTietThongTin.asp?MaChiTietThongTin=<%=RS1("MaChiTietThongTin")%>">Sửa chi tiết thông tin</a><br>
<a href="Sua_ChiTietToChuc.asp?MaChiTietToChuc=<%=RS2("MaChiTietToChuc")%>">Sửa chi tiết tổ chức</a></td><br>
