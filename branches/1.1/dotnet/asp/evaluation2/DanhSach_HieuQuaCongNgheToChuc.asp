...
<title>Danh sách hiệu quả công nghệ tổ chức</title>
<!-- InstanceEndEditable -->
...
Dim p
	...
	sqlStr = "SELECT * FROM HieuQuaCongNghe_ToChuc inner join SanPham on SanPham.MaSanPham = HieuQuaCongNghe_ToChuc.MaSanPham inner join HoiDong on HoiDong.MaHoiDong = HieuQuaCongNghe_ToChuc.MaHoiDong where HoiDong.MaDoanhNghiep=" & RSDoanhNghiep(0)
		...
		RS.Open sqlStr, conn
			...
			%>
			<h3 align="center">Danh sách hiệu quả công nghệ tổ chức</h3>
			...
			<form action="DanhSach_HieuQuaCongNgheToChuc.asp" method="get" name="viewFrm" id="viewFrm">
