...
<title>Danh sách điểm bước gia công</title>
<!-- InstanceEndEditable -->
...
<script  language="JavaScript" type="text/javascript">
	function move(){
		window.location = "Nhap_DiemBuocGiaCong.asp"
	}
...
Dim p
	...
	strSQL = "SELECT *,TensanPham,TenHoiDong FROM BuocGiaCong inner join SanPham on SanPham.MaSanPham = BuocGiaCong.MaSanPham inner join HoiDong on HoiDong.MaHoiDong = BuocGiaCong.MaHoiDong where HoiDong.MaDoanhNghiep = "&RSDoanhNghiep(0)
	...
	'Response.Write(strSQL)
		...
		RS.Open strSQL, conn
			...
			%>
			<h3 align="center">Danh sách điểm bước gia công</h3>
			<table width="100%" border="1" cellpadding="5" align="center">
			  <tr align="center" >
  				
				 <td><div align="center">Tên bước gia công </div></td>
    			<td><div align="center">T&ecirc;n sản phẩm </div></td>
   				 <td><div align="center">T&ecirc;n hội đồng</div></td>
    			<td><div align="center">Alpha T</div></td>
			...
			%>
			  <tr>
					  ...
					  <td><div align="center"><%=RS("TenBuocGiaCong")%></td>
    					<td> <%=RS("TenSanPham")%></td>
   						 <td><div align="center"><%=RS("TenHoiDong")%></div></td>
   					 <td>&nbsp;<div align="center"><%=RS("AlphaT")%></div></td>
  					  <td><div align="center">&nbsp;<%=RS("GhiChu")%></div></td>
					  <td><a href="Sua_DiemBuocGiaCong.asp?MaBuocGiaCong=<%=RS("MaBuocGiaCong")%>">Sửa</a></td>
					  <td><a href="javascript:del(<%=RS("MaBuocGiaCong")%>)">Xóa</a></td>
				  </tr>
			  <%	
			RS.MoveNext
			wend
			...
			<p>
			  <input type="button" name="Button" value="Tạo mới bước gia công nhấn vào đây"  onclick="window.location='TaoMoiSanPham.asp?loai=BuocGiaCong'"/>
			</p>
			<%
			...
			<form action="DanhSach_DiemBuocGiaCong.asp" method="get" name="viewFrm" id="viewFrm">
...
%>
            <p align="right">&nbsp;</p>
            <form action="Xoa_DiemBuocGiaCong.asp" method="get" name="delFrm" id="delFrm">
