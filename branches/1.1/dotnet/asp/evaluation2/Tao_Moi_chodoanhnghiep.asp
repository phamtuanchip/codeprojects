...
<title>Tạo mới các chi tiết cho doanh nghiệp</title>
<!-- InstanceEndEditable -->
        ...
        <tbody>
          ...
          colspan="2" height="100%"><table width="554" border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <p>Bạn đang quản trị cho doanh nghiệp:				    </p>
...
<fieldset > 
                 ...
                 <%rsdoanhnghiep.open "select * from doanhnghiep where madoanhnghiep="& Session("ma_dn"),conn%>
				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="35">Địa chỉ thư điện tử: <a mailto:<%=rsdoanhnghiep("email")%>><%=rsdoanhnghiep("email")%></a></td>
                      <td>Trang chủ: <a href="http://<%=rsdoanhnghiep("website")%>"> <%=rsdoanhnghiep("website")%> </a></td>
                    </tr>
                    <tr>
                      <td colspan="2">Trang giới thiệu: <a href="<%=rsdoanhnghiep("http")%>" target="_blank"><%=right(rsdoanhnghiep("http"),len(rsdoanhnghiep("http"))-10)%></a></td>
                    </tr>
                    <tr>
			...
			<%end if%>
				  ...
				  Ghi chú : <br />
				  * Bạn phải tạo ít nhất 1 hội đồng thì mới có thể làm được các tác vụ sau: <br />
				    +Tạo các chỉ tiêu đánh giá cho sản phẩm <br />
				     +Nhập mới các chỉ tiêu kinh tế     <br />
				         *Bạn phải tạo mới ít nhất 1 thiết bị thì mới tạo được: <br /> 
				         +Bước gia công<br />
				         +Tạo mới sản phẩm cho doanh nghiệp <br />
				         * Sau khi tạo mới hoàn thiện bạn phải 
			          nhập Danh sách điểm đưa vào để đánh giá<br />
			          * Và sau cùng là nhập các hệ số trọng lượng <br />
			          <pre><h3>    I, Tạo mới cho doanh nghiệp </h3></pre>
			          <ul><li><strong>1 <a href="TaoMoiHoiDong.asp" title="Tạo mới một Hội Đồng để chấm điểm cho các Doanh Nghiệp" >Tạo mới hội đồng.</a></strong></li>
				    <li><strong>1.1<a href="TaoMoiThanhVien.asp" title="Tạo mới một Thành Viên để làm việc cho Hội Đồng"> Tạo mới thành viên.</a></strong></li>
				    <li><strong>1.2 <a href="XemDanhSach.asp?loai=HoiDong">Thêm thành viên vào hội đồng</a> </strong></li>
				    <li><strong>2 <a href="TaoMoiThietBi.asp" title="Tạo mới Thiết Bị">Tạo mới thiết bị cho doanh nghiệp.</a></strong></li>
				    <li><strong>3 <a href="TaoMoiSanPham.asp" title="Tạo mới sản phẩm cho Doanh Nghiệp">Tạo mới sản phẩm cho doanh nghiệp.</a></strong></li>
				    <li><strong>3.1 <a href="TaoMoiSanPham.asp?loai=BuocGiaCong" title="Tạo mới Bước gia công cho sản phẩm">Tạo mới bước gia công cho sản phẩm của doanh nghiệp.</a></strong></li>
				    <li><strong>4 <a href="BangChiTieu.asp">Tạo mới chỉ tiêu đánh giá cho sản phẩm </a></strong></li>
				    <li><strong>5 <a href="ChiTieuKinhTe.asp">Nhập các chỉ tiêu kinh tế</a></strong></li>
					<li><strong>6 <a href="ChiTieuKyThuat.asp">Nhập các chỉ tiêu kỹ thuật</a></strong></li>
				     <pre> <h3>II, Danh sách điểm sẽ đưa vào  để chấm </h3></pre>
					
				    <li><strong>--- <a href="DanhSach_ChiTietThongTin.asp">Điểm tiêu chuẩn thông tin</a></strong></li>
				    <li><strong>---                        <a href="DanhSach_HieuQuaCongNgheThongTin.asp">Điểm hiệu quả công nghệ thông tin</a></strong></li>
				    <li><strong>--- <a href="danhsach_hieuquacongnghekythuat.asp">Điểm hiệu quả công nghệ kỹ thuật</a> </strong></li>
				    <li><strong>---                          <a href="danhsach_chitiettochuc.asp">Điểm tiêu chuẩn tổ chức</a></strong></li>
				    <li><strong>---				      <a href="DanhSach_HieuQuaCongNgheToChuc.asp">Điểm hiệu quả công nghệ tổ chức</a></strong></li>
				    <li><strong>--- <a href="danhsach_nhantoconnguoi.asp">Điểm nhân tố con người </a></strong></li>
				    <li><strong>--- <a href="DanhSach_NhanToMoiTruong.asp">Điểm nhân tố môi trường </a></strong></li>
				    <li><strong>---				      <a href="DanhSach_DiemBuocGiaCong.asp">Yếu tố công nghệ</a></strong>				      </li>
				    <li><strong>---</strong> <a href="DanhSachHeSoTrongLuong.asp"><strong>Nhập các hệ số trọng lượng </strong></a></li>
			          </ul>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
