...
function setValue(page) 
{
	...
	function move(){
		window.location = "Nhap_ChiTietThongTin.asp"
	}
...
function istxtChiTietThongTinEmpty(formtimma) {
      if ( 	formtimma.timma.value == ""){
          alert("Bạn phải nhập tên chi tiết thông tin cần tìm");
          return false;
       }
	   else {
          return true;
...
<form name="formtimma" method="post" action="Tim_ChiTietThongTin.asp" onsubmit="return validateForm(this)">
<table>
  <tr align="center">
  	<td>Nhập tên chi tiết thông tin cần tìm</td>	
...
<%
dim sqlStr
sqlStr ="select * from ChiTietThongTin inner join SanPham on SanPham.MaSanPham = ChiTietThongTin.MaSanPham inner join HoiDong on HoiDong.MaHoiDong = ChiTietThongTin.MaHoiDong where TenChiTietThongTin = N'"+ Request.Form("timma")+ "'"

	RS.Open sqlStr, conn
		
			%>			<h3 align="center">Kết quả tìm kiếm</h3><table width="100%" border="1" cellpadding="5" align="center">
			    <tr align="center" >
				  
				  <td align="center"><b>Tên chi tiết thông tin</b></td>
			...
			%>
				  <tr>
					  ...
					  <td align="center"><%=RS("TenChiTietThongTin")%></td>
					  <td align="center"><%=RS("TenSanPham")%></td>
					  <td align="center"><%=RS("TenHoiDong")%></td>
					  <td align="center"><%=RS("GhiChu")%></td>
	  <td><a href="Sua_ChiTietThongTin.asp?MaChiTietThongTin=<%=RS("MaChiTietThongTin")%>">Sửa</a></td>
	  <td><a href="javascript:del(<%=RS("MaChiTietThongTin")%>)">Xóa</a></td>
				  </tr>
			  <%	
			RS.MoveNext
			wend
...
<form action="Xoa_ChiTietThongTin.asp" method="get" name="delFrm" id="delFrm">
