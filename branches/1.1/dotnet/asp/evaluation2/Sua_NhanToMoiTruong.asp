...
<title>Sửa nhân tố môi trường</title>
<!-- InstanceEndEditable -->
...
Dim RsSua
Dim str
str = "SELECT * FROM DSNTMoiTruongView WHERE MaDoanhNghiep=" & Session("ma_dn") & " AND MaNhanToMoiTruong="& Request.QueryString("MaNhanToMoiTruong")
set RsSua = Server.CreateObject("ADODB.Recordset")
RsSua.Open str,conn
%>
<center><font face="Arial, Helvetica, sans-serif" color="#006633" size="4">Sửa nhân tố môi trường</font>
<p>
Chú ý : Bạn không thể sửa những trường khóa có dấu (*)
</center>
<form name="formsuanhantomoitruong" id="formsuanhantomoitruong" method="post" action="Save_NhanToMoiTruong.asp" onSubmit="return validateForm(this)">
  <table width="418" border="0" align="center">
    <tr>
      <td width="172"></td>
      <td width="230"><input name="mantmt" type="hidden" id="mantmt" value="<%=RsSua("MaNhanToMoiTruong")%>" readonly>&nbsp;&nbsp;</td>
    </tr>
    <tr>
      <td>Tên sản phẩm</td>
      <td><input name="masp" type="text" id="masp" value="<%=RsSua("TenSanPham")%>" size="30" readonly> *</td>
    </tr>
    <tr>
      <td>Tên hội đồng </td>
      <td><input name="mahd" type="text" id="mahd" value="<%=RsSua("TenhoiDong")%>" size="30" readonly> * </td>
    </tr>
    <tr>
      <td>Tên nhân tố môi trường</td>
      <td><textarea name="tenntmt" cols="45" rows="5" id="tenntmt"><%=RsSua("TenNhanToMoiTruong")%></textarea></td>
    </tr>
	<tr>
      <td valign="top">Ghi ch&uacute;</td>
      <td><textarea name="ghichu" id="ghichu" rows="10" cols="45"><%=RsSua("GhiChu")%></textarea></td>
	</tr>
    <tr>
