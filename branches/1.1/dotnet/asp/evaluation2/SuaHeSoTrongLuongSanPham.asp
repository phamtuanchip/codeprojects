...
function MM_validateForm() { //v4.0
  ...
  } if (errors) alert('Có những lỗi sau: '+errors);
...
<%
	dim MaHeSoTrongLuong_SanPham
	MaHeSoTrongLuong_SanPham = Request.QueryString("MaHeSoTrongLuong_SanPham")
	strSQL = "select * from HeSoTrongLuong where MaHeSoTrongLuong_SanPham = " + MaHeSoTrongLuong_SanPham
	RS.open strSQL, conn
%><br />
<div align="center">SỬA HỆ SỐ TRỌNG LƯỢNG</div>
<form action="SaveHeSoTrongLuong.asp" method="post" name="form1" id="form1" onsubmit="MM_validateForm('TenHeSoTrongLuong','','R');return document.MM_returnValue">
  <table width="100%" border="1">
    <tr>
      <th scope="row">Tên hệ số trọng lượng</th>
      <td><input type="text" name="TenHeSoTrongLuong" id="TenHeSoTrongLuong" value="<%=RS("TenHeSoTrongLuong")%>" />
        <input type="hidden" name="MaHeSoTrongLuong_SanPham" value="<%=RS("MaHeSoTrongLuong_SanPham")%>" /></td>
    </tr>
    <tr>
      <th scope="row">Điểm hệ số trọng lượng </th>
      <td><input type="text" name="diemhesotrongluong" id="diemhesotrongluong" value="<%=RS("diem")%>" />
        <input name="mahoidong" type="hidden" id="mahoidong" value="<%=Request.QueryString("MaHoiDong")%>" /></td>
    </tr>
    <tr>
      <th scope="row">Mô tả </th>
      <td><textarea name="GhiChu" rows="4" id="GhiChu"><%=RS("GhiChu")%></textarea></td>
    </tr>
    <tr>
      <td ><div align="right">
