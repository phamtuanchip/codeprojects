          ...
          colspan="2" height="100%"><table width="554" border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <!--<table width="100%" border="1">
                    <tr>
                      <td><p>Danh sách doanh nghiệp</p>
                        </td>
                      <td> Phân loại doanh nghiệp
                        <select name="select">
                        </select></td>
                    </tr>
                  </table>-->
            ...
            <%     dim rshh,rscount
			       set rshh =server.CreateObject("adodb.recordset")
					  ...
					  rshh.open " select * from doanhnghiep  where status=1 and isActive=1",conn
			...
			<td align='center' valign='top' nowrap='nowrap'>
			  <div align='center'>
				...
				<% rscount.open " select count(*) as dem from sanpham where madoanhnghiep= "&rshh("madoanhnghiep"),conn %>
				<a href="chitietdoanhnghiep.asp?maso=<%=rshh("madoanhnghiep")%>" target="_self">
			        <img src="<%=rshh("logo")%>" width="115" height="115" hspace="0" vspace="0" border="0" align="absbottom" title="<%=rshh("tendoanhnghiep")%>" /></a><br />
				<%=rshh("tendoanhnghiep")%><br />
				<a href="chitietdoanhnghiep.asp?maso=<%=rshh("madoanhnghiep")%>" target="_self"> Số lượng sản phẩm (<%=rscount("dem")%>)</a>
				<br />
			    <%  rscount.close() %>
				<% if dem mod 2 = 0 then %>
			     <% Response.Write  " </div></td><td align='center' valign='top'  style='padding-left: 3px'><div align='center'>"%>
			    <% end if %>
			    <% if dem mod 6 = 0 then %>
			    <% Response.Write  "</div></td><tr><td align='center' valign='top'  style='padding-left: 3px'><div align='center'>"%>
			    <% end if %>
			    <%rshh.movenext()
					  	dem=dem+1
					  %>	
