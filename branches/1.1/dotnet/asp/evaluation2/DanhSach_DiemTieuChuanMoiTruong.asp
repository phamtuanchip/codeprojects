...
Dim p
	...
	sqlStr = "SELECT * FROM DSDiemTCMoiTruongView WHERE MaDoanhNghiep="&Session("ma_dn")
		'Phan trang--------------------------------------------------------------------------------------
		RS.CursorLocation = 3
		'3 nhan vien 1 trang
		RS.PageSize =10
		RS.Open sqlStr, conn
			...
			%>
			<h3 align="center">Danh sách điểm tiêu chuẩn môi trường</h3>
			<table width="100%" border="1" cellpadding="5" align="center">
			  <tr align="center" >
			    <td align="center"><b>T&ecirc;n nhân tố môi trường</b></td>
				  <td align="center"><b>T&ecirc;n bước gia công</b></td>
			...
			<form action="DanhSach_DiemTieuChuanMoiTruong.asp" method="get" name="viewFrm" id="viewFrm">
...
%>
            ...
            <!--#include file=select.inc-->            <form action="Xoa_DiemTieuChuanMoiTruong.asp" method="get" name="delFrm" id="delFrm">
