...
%>
<h2 align="center">PHIẾU CHO ĐIỂM SẢN PHẨM THEO CÔNG ĐOẠN SẢN XUẤT</h2>
<br />
<br />
<form id="form1" name="form1" method="post" action="">
  <table width="100%" border="1">
    ...
    <tr>
      <th width="7%" scope="col">Min</td>
    <th width="7%" scope="col">Max</td>    </tr>
    <tr>
      ...
      <td>Cao: 8, 9<br />
        Chấp nhận được: 7, 8 <br />
        Chất lượng sản phẩm đạt yêu cầu: 6, 7<br />
        Không đạt, không ổn định </td>
    </tr>
	...
	<tr>
      ...
      <td> Ghi chú
      <textarea name="GhiChu" id="GhiChu" cols="25" rows="3"></textarea></td>
	</tr>
	<%
		RSBGC.MoveNext
		wend
    ...
    <tr>
      ...
      <td>Đồng bộ hoàn toàn: 8, 9<br />
        Đồng bộ từng phần: 7, 8<br />
        Không đồng bộ: 6, 7 </td>
    </tr>
    <%
		RSBGC.open strBGC, conn
		while not (RSBGC.EOF)
    ...
    <tr>
      ...
      <td>Tự động Cơ - Điện - Điện tử hiện đại: 8, 9<br />
        Tự động một phần: 7, 8<br />
        Tự động chuyên dụng: 6, 7 </td>
    </tr>
    <%
		RSBGC.open strBGC, conn
		while not (RSBGC.EOF)
