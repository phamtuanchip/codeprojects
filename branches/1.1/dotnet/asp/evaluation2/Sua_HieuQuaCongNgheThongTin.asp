...
<title>Sửa hiệu quả công nghệ thông tin</title>
<!-- InstanceEndEditable -->
...
Dim RsSua
Dim str
str = "select * from HieuQuaCongNghe_ThongTin inner join HoiDong on HieuQuaCongNghe_ThongTin.MaHoiDong = HoiDong.MaHoiDong inner join SanPham on HieuQuaCongNghe_ThongTin.MaSanPham = SanPham.MaSanPham where HieuQuaCongNghe_ThongTin.MaHieuQuaCongNghe_ThongTin = '"+ Request.QueryString("MaHieuQuaCongNghe_ThongTin")+ "'"
set RsSua = Server.CreateObject("ADODB.Recordset")
RsSua.Open str,conn
%><center><font face="Arial, Helvetica, sans-serif" color="#006633" size="4">Sửa hiệu quả công nghệ thông tin</font>
<p>
Chú ý : Bạn không thể sửa những trường khóa có dấu (*)
</center>
<form name="formsuahieuquacongnghethongtin" id="formsuahieuquacongnghethongtin" method="post" action="Save_HieuQuaCongNgheThongTin.asp" onSubmit="return validateForm(this)">
  <table width="93%" border="0" align="center">
    <tr>
      <td width="206"></td>
      <td width="299"><input name="mahqcntt" type="hidden" id="mahqcntt" value="<%=RsSua("MaHieuQuaCongNghe_ThongTin")%>" readonly>&nbsp;&nbsp;</td>
    </tr>
    <tr>
      <td>Tên hiệu quả công nghệ thông tin</td>
      <td><textarea name="tenhqcntt" cols="35" id="tenhqcntt"><%=RsSua("TenHieuQuaCongNghe_ThongTin")%></textarea></td>
    </tr>
    <tr>
      <td>Tên sản phẩm</td>
   ...
   <tr>
	...
	<tr>
      <td>Ghi chú</td>
      <td><textarea name="ghichu" id="ghichu" rows="8" cols="35"><%=RsSua("GhiChu")%></textarea></td>
    </tr>
    <tr>
