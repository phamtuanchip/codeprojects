...
<html xmlns="http://www.w3.org/1999/xhtml"><head></head><!-- InstanceBegin template="/Templates/hinhmaunguoidung.dwt.asp" codeOutsideHTMLIsLocked="false" -->
<head>
...
height="70"><table cellspacing="0" cellpadding="0" border="0">
	...
	<%
		dim idguest
		idguest = Request.QueryString("idguest")
		RS.open "delete from guest where idguest = " & idguest & "", conn
