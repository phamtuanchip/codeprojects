...
<script  language="javascript">
	function newopen()
	{
	var newWind = window.open("HuongDan.asp", "newWind","menubar,status,resizable", "status,menubar,height=1000,width=1200");
...
sqlStr = "SELECT * FROM ChiTietThongTin inner join SanPham on SanPham.MaSanPham = ChiTietThongTin.MaSanPham inner join HoiDong on HoiDong.MaHoiDong = ChiTietThongTin.MaHoiDong where HoiDong.MaDoanhNghiep = '"& session("ma_dn") &"'" 
		...
		RS.Open sqlStr, conn
			...
			%>			
<h3 align="center">Danh sách chi tiết thông tin</h3>
<table width="100%" border="1" cellpadding="5" align="center">
  <tr align="center" >
    ...
    <td align="center"><b>Tên chi tiết thông tin</b></td>
				    ...
				    <td align="center"><b>Alpha I</b></td>
...
<form action="DanhSach_ChiTietThongTin.asp" method="get" name="viewFrm" id="viewFrm">
  
  <p align="right">
    <input type="hidden" name="page" value="<%=rsCurrentPage%>"/><input type="button" name="nhap" value="Thêm mới" onclick="move()" />
