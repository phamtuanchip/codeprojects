...
%>        
              ...
              <div align="right"><br>
			  <span class="tex_de_muc">Mã phiếu</span> :<%=Request.QueryString("MaPhieu")%>
              </div>
  ...
  <tr>
    ...
    <td width="298" bgcolor="#E4E4E4"><div align="center">Tên thiết bị</div></td>
	 <td width="104" bgcolor="#E4E4E4"><div align="center">Số lượng nhập</div></td>
	 <td width="53" bgcolor="#E4E4E4"><div align="center">Sửa</div></td>
	 <td width="45" bgcolor="#E4E4E4"><div align="center">Xóa</div></td>
  </tr>
<%
	RS = oConn.Execute("SELECT ma_tb,ten_tb,so_luong_nhap FROM PHIEU WHERE ma_phieu ="+MaPhieu);
%>
<%
var i=1;
while(!RS.EOF){
...
<%RS.MoveNext}%>  
 ...
 <p align="right"><a href="VOrder.asp">Quay lại  </a>
