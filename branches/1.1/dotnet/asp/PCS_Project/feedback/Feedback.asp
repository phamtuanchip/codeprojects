...
<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="" onLoad="MM_preloadImages('../images/menu11.jpg','images/menu_lien_he_11.gif','../images/menu_home_11.gif','../images/tkct.png')">
<div align="center"> 
...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="59"><p><a href="../default.asp" target="_top" onClick="MM_nbGroup('down','group1','menu_home','',1)" onMouseOver="MM_nbGroup('over','menu_home','../images/menu_home_11.gif','',1)" onMouseOut="MM_nbGroup('out')"><img src="../images/menu_home_11.gif" alt="" name="menu_home" width="150" height="22" border="0" ></a>
      <a href="../customers/search_customers_adv.asp" target="_top" onClick="MM_nbGroup('down','group1','menu_home','',1)" onMouseOver="MM_nbGroup('over','menu_home','../images/tkct.png','',1)" onMouseOut="MM_nbGroup('out')"><img src="../images/tkct.png" alt="" name="menu_home" width="150" height="22" border="0" ></a> </p></td>
    <td><p>&nbsp;</p>
        <p>&nbsp;</p></td>
  </tr>
</table>
          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
              ...
              <td width="96%" valign="top"><!-- InstanceBeginEditable name="nhom_thietke" --> 
                    <form action="InsertFeedback.asp" method="post" name="gop_y" id="gop_y">
                      <table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#009999" bgcolor="#E0E0E0" rules="none" class="Link">
                        <tr> 
                          <td colspan="2"><div align="center" class="Folder">Góp ý của khách 
                              hàng</div></td>
                        </tr>
                        <tr> 
                          <td width="30%" class="Normal"><div align="right">Tên</div></td>
                          <td width="70%"> <input name="ten" type="text" id="ten"> 
                          </td>
                        </tr>
                        <tr> 
                          <td class="Normal"><div align="right">Email</div></td>
                          <td> <input name="email_kh" type="text" id="email_kh"> </td>
                        </tr>
                        <tr> 
                          <td class="Normal"><div align="right">Tiêu đề</div></td>
                          <td> <input name="tieude" type="text" id="tieude" size="55"> </td>
                        </tr>
                        <tr> 
                          <td valign="top" class="Normal"><div align="right">Nội dung</div></td>
                          <td> <textarea name="noidung" cols="50" rows="8" class="Link" id="noidung"></textarea> 
                          </td>
                        </tr>
                        <tr> 
                          <td>&nbsp;</td>
                          <td> <input name="Submit2" type="submit" class="VoteButton" value="Submit"> 
                            <input name="Submit3" type="reset" class="VoteButton" value="Reset"> 
                          </td>
                        </tr>
                      </table>
                    </form>
