...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="59"><a href="default.asp" target="_top" onClick="MM_nbGroup('down','group1','menu_home','',1)" onMouseOver="MM_nbGroup('over','menu_home','images/menu_home_11.gif','',1)" onMouseOut="MM_nbGroup('out')"><img src="images/menu_home_01.gif" alt="" name="menu_home" border="0" ></a> <a href="lien_he.asp" target="_top" onClick="MM_nbGroup('down','group1','menu_lien_he','',0)" onMouseOver="MM_nbGroup('over','menu_lien_he','images/menu_lien_he_11.gif','',0)" onMouseOut="MM_nbGroup('out')"><img src="images/menu_lien_he_01.gif" alt="" name="menu_lien_he" border="0" ></a></td>
    <td>
	<%
		//Response.Expires = -1;
...
<p>&nbsp;</p>
          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
              <td width="4%">&nbsp;</td>
              <td width="96%" valign="top"><!-- InstanceBeginEditable name="nhom_thietke" -->nhom_thietke<!-- InstanceEndEditable --></td>
              </tr>
          </table>
              <p class="list">&nbsp;</p></td>
        </tr>
