          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
              ...
              <td width="96%" valign="top"><!-- InstanceBeginEditable name="nhom_thietke" -->
                    <div align="left"> 
                      <%
//Kiem tra username,pass truoc khi vao admin
...
%>
	...
	rs.CursorLocation = 3;
	 //4 nhan vien 1 trang
	rs.PageSize = 4;
	rs.Open("SELECT NV.ma_nv,NV.ten_nv,NV.trang_thai,CV.ten_chuc_vu FROM NHANVIEN NV inner join CHUCVU CV on NV.ma_chuc_vu = CV.ma_chuc_vu ", oConn);
...
%>
                    ...
                    <form name="form1" method="post" action="Searchnv.asp">
                      <table width="562" border="0" cellpadding="5">
                        <tr> 
                          <td colspan="3" class="tex_de_muc"><div align="center"> 
                              <p class="Folder">Quản lý nhân viên</p>
                            </div></td>
                        </tr>
                        <tr> 
                          <td colspan="3" class="Link">Tìm kiếm nhân viên</td>
                        </tr>
                        <tr> 
                          <td width="105">Tên nhân viên</td>
                          <td width="411" colspan="2"><input name="manv" type="text" id="manv" size="15"></td>
                        </tr
                    >
                        <tr> 
                          <td>Chức v&#7909;</td>
                          <td colspan="2"> 
                            <%var RS = oConn.Execute("select * from CHUCVU")%>
                            <select name="macv" id="macv">
                              <option>---Chọn chức vụ ---</option>
                              <%while (!RS.EOF){%>
                              <option value="<%=RS("ma_chuc_vu")%>"> 
                              <%=RS("ten_chuc_vu")%>
                              </option>
                              <%
						  RS.MoveNext }
						  %>
                            </select> <input name="timnv" type="submit" class="VoteButton" id="timnv" value="Tìm"></td>
                        </tr>
                        <tr> 
                          <td colspan="3">&nbsp;</td>
                        </tr>
                        <tr> 
                          <td height="31" colspan="3"><a href="Addnv.asp" class="ShowNext">Thêm 
                            nhân viên mới</a></td>
                        </tr>
                      </table>
                      <p> 
                      <hr>
                      <p align="center"><span class="Folder">Danh sách nhân viên</span></p>
                    </form>
                    <table width="565" border="1" cellpadding="5" cellspacing="0" bordercolor="#C0C0C0" class="Link">
                      <tr bgcolor="#CCCCCC"> 
                        <td width="158"><div align="center">Họ và tên</div></td>
                        <td width="139"><div align="center">Chức vụ</div></td>
                        <td width="139"><div align="center">Trạng thái</div></td>
                        <td width="79"><div align="center">Chức n&#259;ng</div></td>
                      </tr>
                      <% 				 	
					...
					%>
                      <TR> 
                        <td><a href="nvDetail.asp?manv=<%=rs("ma_nv")%>" class="ShowNext"> 
                          <%=rs("ten_nv")%>
                          </a></td>
                        <td class="Link"> 
                          <%=rs("ten_chuc_vu")%>
                        ...
                        <td><div align="center"><a href="Editnv.asp?manv=<%=rs("ma_nv")%>" class="ShowNext">Sửa</a></div></td>
                      </TR>
                      <%
						rs.MoveNext();
						}
	...
	%>
                    ...
                    <form name="viewFrm" method="get" action="admin.asp">
                      <p> 
                        <input type="hidden" name="page" value="<%=rsCurrentPage%>"/>
                      </p>
                    </form>
                    <form action="Delete.asp" name="delFrm">
