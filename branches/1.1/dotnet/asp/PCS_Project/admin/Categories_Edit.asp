          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
              ...
              <td width="96%" valign="top"><!-- InstanceBeginEditable name="nhom_thietke" -->
                <p>
                  <!--#include file = "../Connections/Connection.inc"-->
                  <%rs = oConn.Execute("select * from LOAITHIETBI where ma_loai_tb =" + Request.QueryString("matl"))%>
                </p>
                <form name="form1" method="post" action="SaveEdit_Cate.asp">
                  <table width="100%"  border="1" cellspacing="0" class="Link">
                    <tr>
                      <td colspan="2"><div align="center" class="Folder">Chi tiết loại thiết b&#7883;</div></td>
                    </tr>
                    <tr>
                      <td width="26%">M&atilde; loại tb </td>
                      <td width="74%"><input name="matl" type="text" id="matl" value="<%=rs("ma_loai_tb")%>" size="10"></td>
                    </tr>
                    <tr>
                      <td>T&ecirc;n loại tb </td>
                      <td><input name="tentl" type="text" id="tentl" value="<%=rs("ten_loai_tb")%>"></td>
                    </tr>
                    <tr>
                      <td>K&yacute; hiệu </td>
