...
<p>&nbsp;</p>     
	...
	rs.CursorLocation = 3;
	 //4 nhan vien 1 trang
	rs.PageSize = 10;
	rs.Open("select * from HANGSANXUAT", oConn);
...
%>
                ...
                <form name="form1" method="post" action="">
                  <table width="100%"  border="1" cellspacing="0" class="Link">
                    <tr>
                      <td colspan="4"><div align="center" class="Folder">Danh sách hãng sản xuất</div></td>
                    </tr>
                    <tr bgcolor="#CCCCCC">
                      <td width="9%"><div align="center">Stt</div></td>
                      <td width="41%"><div align="center">Hãng sản xuất</div></td>
                    ...
                    <tr>
                      ...
                      <td><div align="center"><a href="agency_details.asp?masx=<%=rs("ma_hang_sx")%>" class="ShowNext"> <%=rs("ten_hang_sx")%> </a></div></td>
                      <td width="13%"><div align="center"><a href="agency_Edit.asp?masx=<%=rs("ma_hang_sx")%>" class="ShowNext">Sửa</a></div></td>
                      <td width="12%"><div align="center"><a href=javascript:del("<%=rs("ma_hang_sx")%>") class="ShowNext">Xóa</a></div></td>
                    </tr>
                    <%stt = stt +1;
					rs.MoveNext;} 
					%>
	...
	%>
                <p></p>
                <form name="viewFrm" method="get" action="agency.asp">
                  <p>
                    <input type="hidden" name="page" value="<%=rsCurrentPage%>"/>
                  </p>
                </form>
                <form action="Delete_agency.asp" name="delFrm">
                  <input type="hidden" name="option" value="delete" />
                  <input type="hidden" name="masx" >
                </form>
                <%	
