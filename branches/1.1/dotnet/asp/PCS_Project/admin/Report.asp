...
<p>&nbsp;</p>     
          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
              ...
              <!--#include file = "../Connections/Connection.inc"-->
              <form name="form1" method="post" action="Report_result.asp">
                <table width="100%" border="1" cellspacing="0" class="Link">
                  <tr>
                    <td colspan="6"><div align="center" class="Folder">B&aacute;o c&aacute;o theo phiếu nhận thiết b&#7883;</div></td>
                  </tr>
	  ...
	  %>
                    ...
                    <td colspan="4"><input name="tenphieu"  type="hidden" id="tenphieu"></td>
                  </tr>
                  <%rs = oConn.Execute("Select * from TRANGTHAI_TB")%>
                  <tr>
                    <td width="16%">Trạng thái</td>
                    <td width="20%"><select name="trangthai" id="trangthai">
		...
		%>
                    ...
                    <td width="9%">Chọn tháng</td>
                    <td width="11%"><select name="thang" id="thang">
                    ...
                    <td width="10%">Chọn n&#259;m</td>
                    <td width="34%"><select name="nam" id="nam">
                  ...
                  <tr>
                    <td colspan="6"><div align="center">
                        <input name="Submit" type="submit" class="VoteButton" value="Báo cáo">
