          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
              ...
              <td width="96%" valign="top"><!-- InstanceBeginEditable name="nhom_thietke" -->
                <form action="SaveAddcv.asp" method="post" name="Add_cv" id="Add_cv">
                  <table rules="none" width="564" border="1" cellspacing="0">
                    <tr>
                      <td colspan="2"><div align="center" class="Folder">Th&ecirc;m chức v&#7909; mới</div></td>
                    </tr>
                    <tr>
                      <td width="128">Chức v&#7909;</td>
                      <td width="420"><input name="chucvu" type="text" id="chucvu">
                      </td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
