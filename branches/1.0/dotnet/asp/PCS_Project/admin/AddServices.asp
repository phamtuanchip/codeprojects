...
%>
              <form name="form1" method="post" action="SaveAddServices.asp">
                <table width="100%"  border="1" cellspacing="0" class="Link">
                  <tr>
                    <td colspan="2"><div align="center" class="Folder">Th&ecirc;m dịch v&#7909; mới</div></td>
                  </tr>
                  <tr>
                    <td width="26%">T&ecirc;n dịch v&#7909;</td>
                    <td width="74%"><input name="tendv" type="text" id="tendv"></td>
                  </tr>
                  <tr>
                    <td>M&#7889; t&#7843; chi tiết</td>
                    <td><textarea name="mota" cols="50" rows="2" id="mota"></textarea></td>
                  </tr>
                  <tr>
                    <td>Gi&aacute; dịch v&#7909;</td>
                    <td><input name="gia" type="text" id="gia" size="15"></td>
                  </tr>
                  <tr>
                    <td>K&yacute; hiệu dịch v&#7909;</td>
                    <td><input name="kyhieu" type="text" id="kyhieu"></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td><input type="submit" name="Submit2" value="Thêm">
                        <input type="reset" name="Reset" value="Hủy bỏ"></td>
                  </tr>
                </table>
              </form>
              <p>&nbsp;</p>
