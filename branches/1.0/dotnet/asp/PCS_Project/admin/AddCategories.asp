          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
              ...
              <td width="96%" valign="top"><!-- InstanceBeginEditable name="nhom_thietke" -->
                <form name="form1" method="post" action="SaveAddCategories.asp">
                  <table width="100%"  border="1" cellspacing="0" class="Link">
                    <tr>
                      <td colspan="2"><div align="center" class="Folder">Th&ecirc;m loại thiết b&#7883; mới</div></td>
                    </tr>
                    <tr>
                      <td width="22%">T&ecirc;n loại thiết b&#7883;</td>
                      <td width="78%"><input name="loaitb" type="text" id="loaitb"></td>
                    </tr>
                    <tr>
                      <td>K&yacute; hiệu</td>
                      <td><input name="kyhieu" type="text" id="kyhieu" size="10"></td>
                    </tr>
                    <tr>
                      <td>M&ocirc; t&#7843;</td>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td><input name="Submit2" type="submit" class="VoteButton" value="Thêm">
