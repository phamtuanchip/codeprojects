          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
              ...
              <td width="96%" valign="top"><!-- InstanceBeginEditable name="nhom_thietke" -->
                <p>
                  <!--#include file = "../Connections/Connection.inc"-->
                  <%rs = oConn.Execute("select * from DICHVU where ma_loai_dv =" + Request.QueryString("madv"))%>
                </p>
                <form name="form1" method="post" action="SaveEdit_Serv.asp">
                  <table width="100%"  border="1" cellspacing="0" class="Link">
                    <tr>
                      <td colspan="2"><div align="center" class="Folder">Chi tiết dịch v&#7909;</div></td>
                    </tr>
                    <tr>
                      <td width="26%">M&atilde; loại dịch v&#7909;</td>
                      <td width="74%"><input name="madv" type="text" id="madv" value="<%=rs("ma_loai_dv")%>" size="10"></td>
                    </tr>
                    <tr>
                      <td>T&ecirc;n loại dịch v&#7909;</td>
                      <td><input name="tendv" type="text" id="tendv" value="<%=rs("ten_loai_dv")%>"></td>
                    </tr>
                    <tr>
                      <td>K&yacute; hiệu </td>
                      <td><input name="kyhieu" type="text" id="kyhieu" value="<%=rs("ky_hieu")%>" size="10"></td>
                    </tr>
                    <tr>
                      <td>M&ocirc; t&#7843;</td>
                      <td><textarea name="mota" cols="50" rows="2" id="mota"><%=rs("mo_ta")%>
                </textarea></td>
                    </tr>
                    <tr>
                      <td>Gi&aacute; dịch v&#7909;</td>
                      <td><input name="giadv" type="text" id="giadv" value="<%=rs("gia_dv")%>"></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td><input name="Submit2" type="submit" class="VoteButton" value="Cập nhật">
                          <input name="Reset" type="reset" class="VoteButton" value="Hủy bỏ"></td>
                    </tr>
                  </table>
                </form>
                <p>&nbsp;</p>
