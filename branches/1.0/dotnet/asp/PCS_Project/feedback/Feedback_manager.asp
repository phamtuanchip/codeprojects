          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
              ...
              <%
			   		...
			   		rs = oConn.Execute("Select * from GOPY order by ngay_gop_y DESC");
			   %>
              <form action="" method="post" name="form1" class="Normal">
                <table width="100%" border="1" cellspacing="0" bordercolor="#0099CC" class="Link">
                  <tr bgcolor="#CCCCCC">
                    <td colspan="5"><div align="center" class="Folder">&Yacute; kiến x&acirc;y dựng</div></td>
                  </tr>
                  <tr>
                    <td width="37%" height="30" class="Link">Chủ đề</td>
                    <td width="19%" class="Link">Người gửi</td>
                    <td width="19%" class="Link">Ngày gửi</td>
                    <td width="17%">Trạng thái</td>
                    <td width="8%"><div align="center">Xóa</div></td>
                  </tr>
                  <tr>
                    <%while(!rs.EOF) {%>
                    <td><a href="Feedback_detail.asp?magopy=<%=rs("ma_gop_y")%>" class="ShowNext"><%=rs("tieu_de")%></a></td>
                    <td><%=rs("nguoi_gop_y")%></td>
                    <td><%=rs("ngay_gop_y")%></td>
                    <td><%=rs("trang_thai")%></td>
                    <td><div align="center"><a href=javascript:del("<%=rs("ma_gop_y")%>")><img src="../images/off.gif" width="20" height="20" border="0"></a></div></td>
                  </tr>
                  <%rs.MoveNext() }%>
                  <tr>
                    <td>&nbsp;</td>
              ...
              <p>&nbsp;</p>
              <form action="DeleteFeedback.asp" name="delFrm">
