          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
              ...
              <td width="96%" valign="top"><!-- InstanceBeginEditable name="nhom_thietke" -->
				...
				RS = oConn.Execute( " SELECT TT.ma_tin_tuc,NV.ma_nv,NV.ten_nv,TT.chu_de,TT.tom_tat,TT.noi_dung,TT.ngay_gui,TT.anh_url FROM TINTUC TT inner join NHANVIEN NV on TT.ma_nv = NV.ma_nv where TT.ma_tin_tuc=" + Request.QueryString("matin"));
			  %>
</p>
                <form action="SaveEditNew.asp" method="post" name="edit" id="edit">
                  <table width="564" border="1" cellpadding="5" cellspacing="0"  rules="none" class="Link">
                    <tr bgcolor="#CCCCCC">
                      <td height="37" colspan="2"><div align="center" class="Folder">Sửa tin tức</div></td>
                    </tr>
                    <tr>
                      <td width="147">Mã tin tức</td>
                      <td width="385"><input name="matin" type="text"  value="<%=RS("ma_tin_tuc")%>" size="15"></td>
                    </tr>
                    <tr>
                      <td>T&ecirc;n nh&acirc;n vi&ecirc;n</td>
                      <% RS1 = oConn.Execute("Select * from NHANVIEN where ma_nv <>'" + RS("ma_nv") + "'")%>
                      <td><select name="manv" >
                          <option value="<%=RS("ma_nv")%>"><%=RS("ten_nv")%></option>
                          <% while (!RS1.EOF) { %>
                          <option value="<%=RS1("ma_nv")%>"><%=RS1("ten_nv")%></option>
                          <%
						  RS1.MoveNext }
						  %>
                      </select></td>
                    ...
                    <tr>
                      <td>Ch&#7911; &#273;&#7873;</td>
                      <td><input name="chude" type="text" id="chude" value="<%=RS("chu_de")%>"></td>
                    </tr>
                    <tr>
                      <td>Tóm tắt ND </td>
                      <td><textarea name="tomtat" cols="50" rows="2" id="tomtat"><%=RS("tom_tat")%>
                      </textarea></td>
                    </tr>
                    <tr>
                      <td>Nội dung </td>
                      <td><textarea name="noidung" cols="50" rows="7" id="noidung"><%=RS("noi_dung")%></textarea></td>
                    </tr>
                    <tr>
                      <td height="35">&#7842;nh_url</td>
                      <td height="35"><input name="anh" type="text"  value="<%=RS("anh_url")%>"></td>
                    </tr>
                    <tr>
                      <td height="35" colspan="2"><div align="right">
                          <input name="sua" type="submit" class="VoteButton" id="sua" value="Sửa">
