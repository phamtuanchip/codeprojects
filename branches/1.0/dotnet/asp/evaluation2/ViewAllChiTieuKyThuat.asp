...
<p>
  <%
	strSQL = "SELECT dbo.TieuChuanKyThuat.* FROM dbo.TieuChuanKyThuat INNER JOIN dbo.SanPham ON dbo.TieuChuanKyThuat.MaSanPham = dbo.SanPham.MaSanPham WHERE (dbo.SanPham.MaDoanhNghiep ="&Session("ma_dn")&") order by Nam "
	RS.open strSQL, conn
%>
</p>
<table width="100%"  border="1">
  <tr>
    ...
    <th scope="col"><font size="+1" face="Symbol">b</font><sub>T</sub></th>
    <th scope="col"><font size="+1" face="Symbol">b</font><sub>T</sub></th>
    <th scope="col"><font size="+1" face="Symbol">b</font><sub>T</sub></th>
    <th scope="col"><font size="+1" face="Symbol">b</font><sub>T</sub></th>
  </tr>
  ...
  %>
  <tr>
    <td><div align="right"><%=RS("Nam")%></div></td>
    <td><div align="right"><%=RS("Q")%></div></td>
    <td><div align="right"><%=RS("BetaT")%></div></td>
    <td><div align="right"><%=RS("BetaH")%></div></td>
    <td><div align="right"><%=RS("BetaI")%></div></td>
    <td><div align="right"><%=RS("BetaO")%></div></td>
  </tr>
  <%
  	RS.movenext
	wend
