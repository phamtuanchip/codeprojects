...
<script language="javascript">
	function check(){
	document.all.formhieuquacongnghekythuat.tenhqcnkt.focus();
}
function validateForm(f){

	if(!istxtHieuQuaCongNgheKyThuatEmpty(f))
		 return false
	if(!isNumber(f))
		 return false
...
function istxtHieuQuaCongNgheKyThuatEmpty(formhieuquacongnghekythuat) {
      if ( 	formhieuquacongnghekythuat.tenhqcnkt.value == "" &&
			formhieuquacongnghekythuat.tenhqcnkt.value == ""){
          alert("Bạn phải nhập tên hiệu quả công nghệ kỹ thuật");
          return false;
       }
	   else {
          return true;
...
function isNumber(formhieuquacongnghekythuat) {
    var str = formhieuquacongnghekythuat.tenhqcnkt.value;
    var re = /^[a-zA-Z]/;
    str = str.toString( );
    if (!str.match(re)) {
        alert("Tên hiệu quả công nghệ kỹ thuật không được nhập dạng số");
        return false;
    }
    return true;
}
function istxtChonSanPhamEmpty(formhieuquacongnghekythuat) {
      if ( 	formhieuquacongnghekythuat.slSanPham.value == "0"){
...
function istxtChonHoiDongEmpty(formhieuquacongnghekythuat) {
      if ( 	formhieuquacongnghekythuat.slHoiDong.value == "0"){
...
<%
	...
	strGiaCong = "Select MaBuocGiaCong,TenBuocGiaCong from BuocGiaCong where BuocGiaCong.Status=1"
...
%>
<center><font face="Arial, Helvetica, sans-serif" color="#006633" size="4">Nhập hiệu quả công nghệ kỹ thuật</font></center><p>
<table align="center">
<tr>
...
<tr>
<td align="center">Để xem danh sách Hiệu Quả Công Nghệ Kỹ Thuật . Xin hãy nhấn <a href="DanhSach_HieuQuaCongNgheKyThuat.asp">vào đây</a></td>
</tr>

</table>
<form name="formhieuquacongnghekythuat" id="form1" method="post" action="XuLy_NhapHieuQuaCongNgheKyThuat.asp" onsubmit="return validateForm(this)">
  <table width="100%" border="0" align="center">
    <tr>
      <td width="227">T&ecirc;n hiệu qu&#7843; c&ocirc;ng ngh&#7879; kỹ thuật</td>
      <td width="317"><textarea name="tenhqcnkt" cols="40" id="tenhqcnkt"></textarea></td>
    </tr>
    <tr>
      <td>Tên sản phẩm</td>
      <td><select onchange="window.location='Nhap_HieuQuaCongNgheKyThuat.asp?MaSanPham='+this.value" name="slSanPham">
    ...
    <tr>
      <td>Ghi ch&uacute;</td>
      <td><textarea name="ghichu" id="ghichu" rows="10" cols="40"></textarea></td>
    </tr>
	</table>
	<table align="center">
    <tr>
