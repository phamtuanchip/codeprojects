...
<title>Tìm kiếm nhân tố môi trường</title>
<!-- InstanceEndEditable -->
...
dim str
str = "Select TenNhanToMoiTruong from NhanToMoiTruong"
rstim.Open str,conn
%>
<form name="formtimma" method="post" action="Tim_NhanToMoiTruong.asp" onsubmit="return validateForm(this)">
<table>
  <tr align="center">
  	<td>Vui lòng nhập thông tin cần tìm kiếm về nhân tố môi trường</td>	
...
<form name="formtimten" action="Tim_NhanToMoiTruong.asp" method="post">
</form>
<%
dim sqlStr
sqlStr ="select * from NhanToMoiTruong inner join SanPham on SanPham.MaSanPham = NhanToMoiTruong.MaSanPham inner join ThanhVien on ThanhVien.MaThanhVien = NhanToMoiTruong.MaThanhVien where TenNhanToMoiTruong like '"+ Request.Form("timten")+ "' "
	
	RS.Open sqlStr, conn
	if (cint(RS("MaNhanToMoiTruong"))<0) then
	Response.Write("Thông tin bạn cần không có trong cơ sở dữ liệu của chúng tôi, vui lòng kiểm tra lại thông tin")
	
		
			%>			<h3 align="center">Kết quả tìm kiếm nhân tố môi trường</h3><table width="100%" border="1" cellpadding="5" align="center">
			    <tr align="center" >
			...
			%>
				  <tr>
					  ...
					  <td align="center"><%=RS("TenThanhVien")%></td>
