...
<title>Danh sách điểm của doanh nghiệp</title>
<!-- InstanceEndEditable -->
        ...
        <tbody>
          ...
          colspan="2" height="100%"><table width="554" border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <p>Trang liệt kê các danh sách điểm sẽ đưa vào vào để chấm </p>
                  <p><a href="DanhSach_ChiTietThongTin.asp">Danh sách điểm tiêu chuẩn thông tin</a><br />
                    
                      <a href="DanhSach_HieuQuaCongNgheThongTin.asp">Danh sách điểm hiệu quả công nghệ thông tin</a><br />
                    
                      <a href="danhsach_chitiettochuc.asp">Danh sách điểm tiêu chuẩn tổ chức</a><br />
                      <a href="danhsach_nhantoconnguoi.asp">Danh sách điểm nhân tố con người </a><br />
                    
                      <a href="DanhSach_HieuQuaCongNgheToChuc.asp">Danh sách điểm hiệu quả công nghệ tổ chức</a><br />
                    
                      <a href="DanhSach_DiemBuocGiaCong.asp">Danh sách điểm bước gia công</a><br />
                    
                      <a href="danhsach_hieuquacongnghekythuat.asp">Danh sách điểm hiệu quả công nghệ kỹ thuật</a><br />
                      <a href="ViewAllChiTieuKinhTe.asp">Danh sách chỉ tiêu kinh tế </a><br />
                      <a href="ViewAllChiTieuKyThuat.asp">Danh sách chỉ tiêu kỹ thuật </a><br />
                  </p>
