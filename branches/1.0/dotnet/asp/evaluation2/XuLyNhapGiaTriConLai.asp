...
<title>Xử lý nhập điểm giá trị còn lại của sản phẩm</title>
<!-- InstanceEndEditable -->
                ...
                <tr>
				  ...
				  <!-- InstanceBeginEditable name="noidungcuanguoidung " -->
					...
					<%
						...
						T = cdbl(Request.Form("T"))
						H = cdbl(Request.Form("H"))
						N = cdbl(Request.Form("N"))
						C = cdbl(Request.Form("C"))
						k = cdbl(Request.Form("k"))
						
						strSQL = "insert into ThietBi (TenThietBi, NamSanXuat, NoiSanXuat, T, H, N, C, k, MaDoanhNghiep) values (N'" + TenThietBi + "', '" + NamSanXuat + "', N'" + NoiSanXuat + "', " + T + ", " + H + ", " + N + ", " + C + ", " + k + ", " + Session("ma_dn") + ")"
						conn.Execute strSQL
