...
<title>Danh sách các chỉ tiêu kinh tế</title>
<!-- InstanceEndEditable -->
          ...
          colspan="2" height="100%"><table width="554" border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <!-- InstanceBeginEditable name="noidungcuanguoidung " -->
					...
					<%
						strSQL = "select * from ChiTieuKinhTe where MaHoiDong="&Session("ma_hd")&" and MaSanPham="&Session("ma_sp")&""
						RS.open strSQL, conn
					%>
					<table width="100%" border="1">
                      <tr>
                        <td>Chỉ tiêu kinh tế </td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
