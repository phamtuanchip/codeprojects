...
<% 
	MaBuocGiaCong=Request.Form("txtMaBuocGiaCong")
	TenBuocGiaCong=Request.Form("txtTenBuocGiaCong")
	AlPhaT=Request.Form("txtAlPhaT")
	Ghichu=Request.Form("txtghichu")
	

	sql="Update BuocGiaCong set TenBuocGiaCong=N'" & TenBuocGiaCong & "',AlPhaT=" & AlPhaT & ",Ghichu=N'" & Ghichu & "' where MaBuocGiaCong=" & MaBuocGiaCong
	conn.execute sql
