...
<script language="JavaScript" type="text/javascript">
	function check(){
	document.all.formchitietthongtin.tencttt.focus();
}
function validateForm(f){

	if(!istxtChiTietThongTinEmpty(f))
		 return false
...
function istxtChiTietThongTinEmpty(formchitietthongtin) {
      if ( 	formchitietthongtin.tencttt.value == "" &&
			formchitietthongtin.tencttt.value == ""){
          alert("Bạn phải nhập tên chi tiết thông tin");
          return false;
       }
	   else {
          return true;
...
/*function isNumber(formchitietthongtin) {
    var str = formchitietthongtin.tencttt.value;
    var re = /^[a-zA-Z]/;
    str = str.toString( );
    if (!str.match(re)) {
        alert("Tên chi tiết thông tin không được nhập dạng số");
        return false;
    }
    return true;
}*/
function istxtAlphaIEmpty(formchitietthongtin) {
      if ( 	formchitietthongtin.alphai.value == "" &&
			formchitietthongtin.alphai.value == ""){
          alert("Bạn phải nhập Alpha I");
          return false;
       }
	   else {
          return true;
...
function isNumberAlphaI(formchitietthongtin) {
    var str = formchitietthongtin.alphai.value;
    var re = /^[0-9]/;
    str = str.toString( );
    if (!str.match(re)) {
        alert("Alpha I phải là kiểu số");
        return false;
    }
    return true;
}
function istxtChonSanPhamEmpty(formchitietthongtin) {
      if ( 	formchitietthongtin.slSanPham.value == "0"){
...
function istxtChonHoiDongEmpty(formchitietthongtin) {
      if ( 	formchitietthongtin.slHoiDong.value == "0"){
...
%><center>
  <font face="Arial, Helvetica, sans-serif" color="#006633" size="4">Nhập chi tiết thông tin</font>
</center><p>
<table align="center">
<tr>
...
<tr>
<td align="center">Để xem danh sách Chi Tiết Thông Tin . Xin hãy nhấn <a href="DanhSach_ChiTietThongTin.asp">vào đây</a></td>
</tr>

</table>
<form action="XuLy_NhapChiTietThongTin.asp" method="post" name="for                            mchitietthongtin" id="formchitietthongtin" onsubmit="return validateForm(this)">
    <table width="100%" border="0" align="center">
      <tr>	
        <td width="104">Tên chi tiết thông tin </td>
        <td width="407"><textarea name="tencttt" cols="45" id="tencttt"></textarea></td>
      </tr>
      <tr>
        <td>Tên sản phẩm</td>
        <td><select name="slSanPham" onchange="window.location='Nhap_ChiTietThongTin.asp?MaSanPham='+this.value">
	  ...
	  <tr>
	  	<td>Alpha I</td>
		<td><input type="text" name="alphai" value="0" readonly="1" onblur="if ((this.value>=1)||(this.value<0)){alert('Điểm Alpha I không được nhỏ hơn 0 hoặc lớn hơn 1'); this.value='0';};"  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		(Alpha I ban đầu mặc định bằng 0 ) </td>
	  </tr>
      <tr>
        <td>Ghi chú</td>
...
<tr>
<td>
<input type="button" name="taosp" value="Tạo mới Sản Phẩm" onclick="movesp();"/>
</td>
<td>
<input type="button" name="taohd" value="Tạo mới Hội Đồng" onclick="movehd();"/>
</td>
</tr>
</table>
</form>
