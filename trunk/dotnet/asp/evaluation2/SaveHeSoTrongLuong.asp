...
<title>Xử lý nhập hệ số trọng lượng</title>
<!-- InstanceEndEditable -->
          ...
          colspan="2" height="100%"><table width="554" border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <%
					...
					dim TenHeSoTrongLuong
					dim GhiChu
					MaHeSoTrongLuong_SanPham = Request.Form("MaHeSoTrongLuong_SanPham")
					TenHeSoTrongLuong = Request.Form("TenHeSoTrongLuong")
					diemhesotrongluong= Request.Form("diemhesotrongluong")
					mahoidong= Request.Form("mahoidong")
					GhiChu = Request.Form("GhiChu")
					strSQL = "update HeSoTrongLuong set TenHeSoTrongLuong = N'" + TenHeSoTrongLuong + "', GhiChu = N'" + GhiChu + "', diem= "&diemhesotrongluong& " where MaHeSoTrongLuong_SanPham = " + MaHeSoTrongLuong_SanPham
					conn.Execute strSQL
					Response.Redirect("DanhSachHeSoTrongLuong.asp?mahoidong="&mahoidong)
					'Response.Write(MaHeSoTrongLuong_SanPham)
					'Response.Write(TenHeSoTrongLuong)
