...
<title>Cập nhật bảng chỉ tiêu sản phẩm</title>
<!-- InstanceEndEditable -->
...
'	conn.Execute sqlInsert
	...
	'Response.Write("<br>")
	'Response.Write("Bãn đã nhập thành công chỉ tiêu đánh giá" &MaDoanhNghiep&"; "&MaHoiDong  )
	
'	url = "Temp.asp?MaDoanhNghiep="&MaDoanhNghiep&"&"
	Session("MaDoanhNghiep")=MaDoanhNghiep
	Session("MaHoiDong")=MaHoiDong
	Response.Redirect("ThemChiTieu.asp?MaDoanhNghiep="&MaDoanhNghiep& "&MaHoiDong=" &MaHoiDong)
