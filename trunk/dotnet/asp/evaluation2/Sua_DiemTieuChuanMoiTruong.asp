...
<title>Sửa điểm tiêu chuẩn môi trường</title>
<!-- InstanceEndEditable -->
...
Dim RsSua
Dim str
str = "select * from DiemTieuChuanMoiTruong inner join BuocGiaCong on DiemTieuChuanMoiTruong.MaBuocGiaCong = BuocGiaCong.MaBuocGiaCong inner join NhanToMoiTruong on DiemTieuChuanMoiTruong.MaNhanToMoiTruong = NhanToMoiTruong.MaNhanToMoiTruong where NhanToMoiTruong.MaNhanToMoiTruong = '"+ Request.QueryString("MaNhanToMoiTruong")+ "'"
set RsSua = Server.CreateObject("ADODB.Recordset")
RsSua.Open str,conn
%>
<center><font face="Arial, Helvetica, sans-serif" color="#006633" size="4">Sửa điểm tiêu chuẩn môi trường</font>
<p>
Chú ý : Bạn không thể sửa những trường khóa có dấu (*)</center>
<form name="formsuadiemtieuchuanmoitruong" id="formsuadiemtieuchuanmoitruong" method="post" action="Save_DiemTieuChuanMoiTruong.asp" onSubmit="return validateForm(this)">
  <table width="418" border="0" align="center">
    <tr>
      <td width="172">Tên nhân tố môi trường</td>
      <td width="230"><input name="mantmt" type="text" id="mantmt" value="<%=RsSua("TenNhanToMoiTruong")%>" size="30" readonly>
      &nbsp;&nbsp;*</td>
    </tr>
    <tr>
      <td>Tên bước gia công </td>
      <td><input name="mabgc" type="text" id="mabgc" value="<%=RsSua("TenBuocGiaCong")%>" size="30" readonly>
      &nbsp;&nbsp;*</td>
    </tr>
    <tr>
      <td>LamDa</td>
      <td><input name="lamda" type="text" id="lamda" value="<%=RsSua("Lamda")%>" size="30"></td>
    </tr>
