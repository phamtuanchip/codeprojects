...
<script language="javascript">
	function check(){
	document.all.formhieuquacongnghetochuc.tenhqcntc.focus();
}
function validateForm(f){

	if(!istxtHieuQuaCongNgheToChucEmpty(f))
		 return false
	//if(!isNumber(f))
		 //return false
...
function istxtHieuQuaCongNgheToChucEmpty(formhieuquacongnghetochuc) {
      if ( 	formhieuquacongnghetochuc.tenhqcntc.value == "" &&
			formhieuquacongnghetochuc.tenhqcntc.value == ""){
          alert("Bạn phải nhập tên hiệu quả công nghệ tổ chức");
          return false;
       }
	   else {
          return true;
...
//function isNumber(formhieuquacongnghetochuc) {
   // var str = formhieuquacongnghetochuc.tenhqcntc.value;
   // var re = /^[a-zA-Z]/;
   // str = str.toString( );
   // if (!str.match(re)) {
      //  alert("Tên hiệu quả công nghệ tổ chức không được nhập dạng số");
       // return false;
   // }
   // return true;
//}
function istxtChonSanPhamEmpty(formhieuquacongnghetochuc) {
      if ( 	formhieuquacongnghetochuc.slSanPham.value == "0"){
...
function istxtChonHoiDongEmpty(formhieuquacongnghetochuc) {
      if ( 	formhieuquacongnghetochuc.slHoiDong.value == "0"){
...
%>
<center><font face="Arial, Helvetica, sans-serif" color="#006633" size="4">Nhập hiệu quả công nghệ tổ chức</font></center><p>
<table align="center">
<tr>
...
<tr>
<td align="center">Để xem danh sách Hiệu Quả Công Nghệ Tổ Chức. Xin hãy nhấn <a href="DanhSach_HieuQuaCongNgheToChuc.asp">vào đây</a></td>
</tr>

</table>
<form name="formhieuquacongnghetochuc" id="form1" method="post" action="XuLy_NhapHieuQuaCongNgheToChuc.asp" onsubmit="return validateForm(this)">
  <table width="100%" border="0" align="center">
    <tr>
      <td width="157">T&ecirc;n hiệu qu&#7843; c&ocirc;ng ngh&#7879; t&#7893; chức</td>
      <td width="387"><textarea name="tenhqcntc" cols="45" id="tenhqcntc"></textarea></td>
    </tr>
    <tr>
      <td>Tên sản phẩm</td>
      <td><select name="slSanPham" onchange="window.location='Nhap_HieuQuaCongNgheToChuc.asp?MaSanPham='+this.value">
