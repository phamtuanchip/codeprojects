...
<%
	...
	strHoiDong= "select * from HoiDong"
	'strSqlMoiTruong = "Select MaNhanToMoiTruong,TenNhanToMoiTruong from NhanToMoiTruong where MaNhanToMoiTruong not in(select MaNhanToMoiTruong from DiemTieuChuanMoiTruong)"
...
%>
<center><font face="Arial, Helvetica, sans-serif" color="#006633" size="4">Nhập hệ số trọng lượng</font></center>

<p>&nbsp;</p>
				  <form action="" method="post" name="form1" id="form1" onsubmit="MM_validateForm('Tên hệ số trọng lượng','','R','Điểm','','RinRange1:9');return document.MM_returnValue">
				    <table width="100%" border="1">
                      <tr>
                        <td><div align="right">Tên hệ số trọng lượng </div></td>
                        <td><input name="Tên hệ số trọng lượng" type="text" id="Tenhesotrongluong" /></td>
                      </tr>
                      <tr>
                        <td><div align="right">Điểm</div></td>
                        <td><input name="Điểm" type="text" id="diem" /></td>
                      </tr>
                      <tr>
                        <td><div align="right">Ghi chú </div></td>
                        <td><textarea name="Ghi chú" id="ghichu" rows="5" cols="45"></textarea></td>
                      </tr>
                      <tr>
                        <td><div align="right">Hội đồng chấm điểm </div></td>
                        <td>
							<select name="MaHoiDong">
							<%
								while not (RSHoiDOng.EOF)
							%>
