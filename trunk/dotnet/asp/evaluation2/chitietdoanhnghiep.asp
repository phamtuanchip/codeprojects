...
<!-- InstanceBegin template="/Templates/hinhmaunguoidung.dwt.asp" codeOutsideHTMLIsLocked="false" -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<!-- InstanceBeginEditable name="doctitle" -->
<title>Chi tiết doanh nghiệp</title>
...
height="70"><table cellspacing="0" cellpadding="0" border="0">
	   ...
	   if session("quyen")=2 then  ' quyen la nguoi dung cua doanh nghiep	  %>
          ...
          colspan="2" height="100%"><table width="554" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="554"><% if (session("trangthai")=true )then		   %>
											Bạn đang đăng nhập với tài khoản: <a href="suathongtinnguoidunghienthoi.asp">
											<% =session("ten")				  
				  %>
											</a>
											<%end if%>
											...
											<fieldset >
											<%
					dim rsdoanhnghiep, madoanhnghiep
					madoanhnghiep=Request.QueryString("maso")
					set rsdoanhnghiep=server.CreateObject("adodb.recordset")
				 %>
											<% rsdoanhnghiep.open "select * from doanhnghiep where madoanhnghiep='"&madoanhnghiep &"'",conn%>
											<%if not rsdoanhnghiep.eof then %>
											<table width="100%" border="1">
												<tr>
													<td width="23%"><input src="<%=rsdoanhnghiep("logo")%>" type="image"  width="100" height="100"/></td>
													<td width="77%"><h3 align="center" ><%=uCase( rsdoanhnghiep("tendoanhnghiep"))%></h3></td>
												</tr>
												<tr>
													<td colspan="2"><div align="center">Địa chỉ: <%=rsdoanhnghiep("diachi")%><br />
															Điện thoại: <%=rsdoanhnghiep("sodienthoai_fax")%> Email: <a href=mailto:<%=rsdoanhnghiep("email")%>><%=rsdoanhnghiep("email")%></a> Trang chủ: <a href="http://<%=rsdoanhnghiep("website")%>"><%=rsdoanhnghiep("website")%></a></div></td>
												</tr>
											</table>
											<br />
											<legend align="center">Thông tin bổ sung</legend>
											<table width="100%" border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td width="31%">Năm thành lập </td>
													<td width="69%"><%=rsdoanhnghiep("namthanhlap")%></td>
												</tr>
												<tr>
												...
												<tr>
													<td>Trang giới thiệu: <a href="<%=rsdoanhnghiep("http")%>" target="_blank"><%=right(rsdoanhnghiep("http"),len(rsdoanhnghiep("http"))-10)%></a></td>
													<td>&nbsp;</td>
												</tr>
												<tr>
													<td><div align="justify"><%=rsdoanhnghiep("info")%>&nbsp;</div></td>
													<td>&nbsp;</td>
												</tr>
											</table>
											<p>
											...
											<table width="100%" border="1">
												<tr>
													<td align="center"><strong>Danh sách sản phẩm được đánh giá của doanh nghiệp </strong></td>
												</tr>
											</table>
											<br />
			       ...
			       set rshh =server.CreateObject("adodb.recordset")
					  ...
					  rshh.open " select * from sanpham where status=1 and madoanhnghiep='"&madoanhnghiep &"'",conn
					  
			 %>
												<tr>
													<td align='center' valign='top' nowrap='nowrap'><div align='center'>
															<%dem=1%>
															<%	while not rshh.eof%>
															<a href="xemchitiet.asp?ma=" target="_self"> <img src="<%=rshh("AnhSanpham")%>" width="115" height="115" hspace="0" vspace="0" border="0" align="absbottom" title="<%=rshh("tensanpham")%>" /></a><br />
															<a href="xemchitiet.asp?ma=<%=rshh("tensanpham")%>" target="_self"><%=rshh("tensanpham")%></a> <br />
															<% if dem mod 2 = 0 then %>
															<% Response.Write  " </div></td><td align='center' valign='top' nowrap='nowrap'><div align='center'>"%>
															<% end if %>
															<% if dem mod 6 = 0 then %>
															<% Response.Write  "</div></td><tr><td align='center' valign='top' nowrap='nowrap'><div align='center'>"%>
															<% end if %>
															<%rshh.movenext()
					  	dem=dem+1
					  %>
