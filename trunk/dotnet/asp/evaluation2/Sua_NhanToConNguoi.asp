...
<title>Sửa nhân tố con người</title>
<!-- InstanceEndEditable -->
...
Dim RsSua
Dim str
str = "select * from NhanToConNguoi inner join HoiDong on NhanToConNguoi.MaHoiDong = HoiDong.MaHoiDong inner join SanPham on NhanToConNguoi.MaSanPham = SanPham.MaSanPham where NhanToConNguoi.MaNhanToConNguoi = '"+ Request.QueryString("MaNhanToConNguoi")+ "'"
set RsSua = Server.CreateObject("ADODB.Recordset")
RsSua.Open str,conn
%><center><font face="Arial, Helvetica, sans-serif" color="#006633" size="4">Sửa nhân tố con người</font>
<p>
Chú ý : Bạn không thể sửa những trường khóa có dấu (*)
</center>
<form name="formsuanhantoconnguoi" id="formsuanhantoconnguoi" method="post" action="Save_NhanToConNguoi.asp" onSubmit="return validateForm(this)">
  <table width="418" border="0" align="center">
    <tr>
      <td style="display:none" width="172"></td>
      <td width="230"><input name="mantcn" type="hidden" id="mantcn" value="<%=RsSua("MaNhanToConNguoi")%>" readonly>
      &nbsp;&nbsp;</td>
    </tr>
    <tr>
      <td>Tên nhân tố con người</td>
      <td><input name="tenntcn" type="text" id="tenntcn" value="<%=RsSua("TenNhanToConNguoi")%>" size="30"></td>
    </tr>
    <tr>
      <td>Tên sản phẩm</td>
   ...
   <tr>
	...
	<tr>
      <td>AlphaH</td>
      <td><input name="alphah" type="text" id="alphah" value="<%=RsSua("AlphaH")%>" size="30"></td>
    </tr>
