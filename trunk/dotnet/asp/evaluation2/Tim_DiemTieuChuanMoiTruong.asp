...
function setValue(page) 
{
	...
	function move(){
		window.location = "Nhap_DiemTieuChuanMoiTruong.asp"
	}
...
function istxtChiTietThongTinEmpty(formtimma) {
      if ( 	formtimma.timma.value == ""){
          alert("Bạn phải nhập tên nhân tố môi trường cần tìm");
          return false;
       }
	   else {
          return true;
...
<form name="formtimma" method="post" action="Tim_DiemTieuChuanMoiTruong.asp" onsubmit="return validateForm(this)">
<table>
  <tr align="center">
  	<td>Nhập tên nhân tố môi trường cần tìm</td>	
...
<%
dim sqlStr
sqlStr ="select * from DiemTieuChuanMoiTruong inner join NhanToMoiTruong on NhanToMoiTruong.MaNhanToMoiTruong = DiemTieuChuanMoiTruong.MaNhanToMoiTruong inner join BuocGiaCong on BuocGiaCong.MaBuocGiaCong = DiemTieuChuanMoiTruong.MaBuocGiaCong where TenNhanToMoiTruong = N'"+ Request.Form("timma")+ "'"
	
	RS.Open sqlStr, conn
		
			%>			<h3 align="center">Kết quả tìm kiếm điểm tiêu chuẩn môi trường</h3><table width="100%" border="1" cellpadding="5" align="center">
			    <tr align="center" >
				  <td align="center"><b>Tên nhân tố môi trường</b></td>
				  <td align="center"><b>Tên bước gia công</b></td>
			...
			%>
				  <tr>
					  ...
					  <td align="center"><%=RS("TenBuocGiaCong")%></td>
					  <td align="center"><%=RS("Lamda")%></td>
		<td><a href="Sua_DiemTieuChuanMoiTruong.asp?MaNhanToMoiTruong=<%=RS("MaNhanToMoiTruong")%>">Sửa</a></td>
...
<form action="Xoa_DiemTieuChuanMoiTruong.asp" method="get" name="delFrm" id="delFrm">
