...
<script language="javascript">
	function check(){
	document.all.formhieuquacongnghethongtin.tenhqcntt.focus();
}
function validateForm(f){

	if(!istxtHieuQuaCongNgheThongTinEmpty(f))
		 return false
	/*if(!isNumber(f))
		 return false*/
...
function istxtHieuQuaCongNgheThongTinEmpty(formhieuquacongnghethongtin) {
      if ( 	formhieuquacongnghethongtin.tenhqcntt.value == "" &&
			formhieuquacongnghethongtin.tenhqcntt.value == ""){
          alert("Bạn phải nhập tên hiệu quả công nghệ thông tin");
          return false;
       }
	   else {
          return true;
...
/*function isNumber(formhieuquacongnghethongtin) {
    var str = formhieuquacongnghethongtin.tenhqcntt.value;
    var re = /^[a-zA-Z]/;
    str = str.toString( );
    if (!str.match(re)) {
        alert("Tên hiệu quả công nghệ thông tin không được nhập dạng số");
        return false;
    }
    return true;
}*/
function istxtChonSanPhamEmpty(formhieuquacongnghethongtin) {
      if ( 	formhieuquacongnghethongtin.slSanPham.value == "0"){
...
function istxtChonHoiDongEmpty(formhieuquacongnghethongtin) {
      if ( 	formhieuquacongnghethongtin.slHoiDong.value == "0"){
...
%>
<center><font face="Arial, Helvetica, sans-serif" color="#006633" size="4">Nhập hiệu quả công nghệ thông tin</font></center><p>
<table align="center">
<tr>
...
<tr>
<td align="center">Để xem danh sách Hiệu Quả Công Nghệ Thông Tin. Xin hãy nhấn <a href="DanhSach_HieuQuaCongNgheThongTin.asp">vào đây</a></td>
</tr>

</table>
<form name="formhieuquacongnghethongtin" id="form1" method="post" action="XuLy_NhapHieuQuaCongNgheThongTin.asp" onsubmit="return validateForm(this)">
  <table width="100%" border="0" align="center">
    <tr>
      <td width="162">Tên sản phẩm</td>
      <td width="382"><select name="slSanPham" onchange="window.location='Nhap_HieuQuaCongNgheThongTin.asp?MaSanPham='+this.value">
    ...
    <tr>
      <td>T&ecirc;n hiệu qu&#7843; c&ocirc;ng ngh&#7879; th&ocirc;ng tin </td>
      <td><textarea name="tenhqcntt" cols="45" id="tenhqcntt"></textarea></td>
    </tr>
    <tr>
      <td>Ghi ch&uacute;</td>
