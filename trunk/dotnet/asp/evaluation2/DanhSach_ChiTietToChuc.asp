...
Dim p
	...
	sqlStr = "SELECT * FROM DSChiTietToChucView WHERE MaDoanhNghiep="&Session("ma_dn")
		'Phan trang--------------------------------------------------------------------------------------
		RS.CursorLocation = 3
		'3 nhan vien 1 trang
		RS.PageSize =10
		RS.Open sqlStr, conn
			...
			%>
			<h3 align="center">Danh sách chi tiết tổ chức</h3>
			<table width="100%" border="1" cellpadding="5" align="center">
			  <tr align="center" >
			    ...
			    <td align="center"><b>Tên chi tiết tổ chức</b></td>
				  ...
				  <td align="center"><b>Alpha O</b></td>
			...
			<form action="DanhSach_ChiTietToChuc.asp" method="get" name="viewFrm" id="viewFrm">
