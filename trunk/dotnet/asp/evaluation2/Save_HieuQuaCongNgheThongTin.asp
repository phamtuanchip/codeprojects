...
<%
		...
		dim strMa
  		dim strTen
		dim ghichu
		strMa = Request.Form("mahqcntt")
		strTen = Request.Form("tenhqcntt")
		strghichu = Request.Form("ghichu")
		set RsSua = Server.CreateObject("ADODB.Recordset")
		
strSql = "update HieuQuaCongNghe_ThongTin set TenHieuQuaCongNghe_ThongTin = N'" + strTen + "', GhiChu = N'" + strghichu + "' where MaHieuQuaCongNghe_ThongTin = '" + strMa + "'"
