...
<title>Chọn doanh nghiệp, hội đồng và sản phẩm để xem đánh giá</title>
<!-- InstanceEndEditable -->
...
height="70"><table cellspacing="0" cellpadding="0" border="0">
  ...
  <table width="100%" border="1" align="center">
    <tr>
      <td width="30%">Chọn doanh nghiệp</td>
      <td width="70%"><select name="chondn" id="chondn" onchange="window.location='ChonChon.asp?ma_dn='+this.value">
    ...
    <tr>
      <td>Chọn hội đồng</td>
      <td><select name="chonhd" id="chonhd" onchange="window.location='ChonChon.asp?ma_dn='+chondnhdsp.chondn.value+'&amp;ma_hd='+this.value">
    ...
    <tr>
      <td>Chọn sản phẩm</td>
      <td><select name="chonsp" id="chonsp" onchange="window.location='ChonChon.asp?ma_dn='+chondnhdsp.chondn.value+'&amp;ma_hd='+chondnhdsp.chonhd.value+'&amp;ma_sp='+this.value;">
    ...
    <tr>
      <td>&nbsp;</td>
      <td>
	     <input type="submit" name="Submit" value="Xem đánh giá" />
