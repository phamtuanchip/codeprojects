...
<title>Phiếu cho điểm sản phẩm theo công đoạn</title>
<!-- InstanceEndEditable -->
...
<%
	strSQL = "SELECT dbo.ThanhVien.MaThanhVien, dbo.ThanhVien.TenThanhVien FROM dbo.ThanhVien INNER JOIN dbo.DoanhNghiep ON dbo.ThanhVien.MaDoanhNghiep = dbo.DoanhNghiep.MaDoanhNghiep INNER JOIN dbo.SanPham ON dbo.DoanhNghiep.MaDoanhNghiep = dbo.SanPham.MaDoanhNghiep where DoanhNghiep.MaDoanhNghiep = " + Session("ma_dn") + " and SanPham.MaSanPham = " + Session("ma_sp") + ""
	RS.open strSQL, conn
...
%>
<h3 align="center">PHIẾU CHO ĐIỂM SẢN PHẨM THEO CÔNG ĐOẠN SẢN XUẤT</h3>
<br />
<br />
<form id="form1" name="form1" method="post" action="">
  <table width="100%" border="1">
    <tr>
      <td colspan="2">Nhóm sản phẩm</td>
      <td colspan="2">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="2">Cơ sở sản xuất</td>
      <td colspan="2"><strong><%=RSDN("TenDoanhNghiep")%></strong></td>
    </tr>
    <tr>
      <td colspan="2">Họ tên người chấm điểm</td>
      <td colspan="2"><select name="MaThanhVien">
        <%
				while not (RS.EOF)
			%>
    ...
    <tr>
      <th width="50%" rowspan="2" scope="col">Chỉ tiêu kỹ thuật </th>
      <th colspan="2" scope="col">Điểm</th>
      <th width="36%" rowspan="2" scope="col">Tiêu chuẩn điểm m </th>
    </tr>
    <tr>
      <th width="7%" scope="col">Min</th>
    <th width="7%" scope="col">Max</th>    </tr>
    <tr>
      <td><strong>Tính tương thích công nghệ - thiết bị Ta </strong></td>
	...
	%>
	<tr>
      <td><%=RSBGC("TenBuocGiaCong")%></td>
      <td><div align="center">
        <input name="Tamin" type="text" size="4" />
      </div></td>
      <td><div align="center">
        <input name="Tamax" type="text" size="4" />
      </div></td>
      <td> Ghi chú      
	...
	%>
    <tr>
      <td><em><strong>Tamin trung bình </strong></em></td>
      <td><div align="center">
        <input name="TaminTB" type="text" id="TaminTB" size="4" />
      </div></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td><strong><em>Tamax trung bình </em></strong></td>
      <td>&nbsp;</td>
      <td><div align="center">
        <input name="TamaxTB" type="text" id="TamaxTB" size="4" />
      </div></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td><strong>Tính đồng bộ của thiết bị trong dây chuyền đồng bộ ĐB</strong> </td>
      <td><div align="center">ĐBmin</div></td>
      <td><div align="center">ĐBmax</div></td>
      <td>&nbsp;</td>
    </tr>
    <%
		RSBGC.open strBGC, conn
	...
	<tr>
      <td><%=RSBGC("TenBuocGiaCong")%></td>
      <td><div align="center">
        <input name="Tamin2" type="text" size="4" />
      </div></td>
      <td><div align="center">
        <input name="Tamax" type="text" size="4" />
      </div></td>
	...
	%>
    <tr>
      <td><em><strong>ĐBmin trung bình </strong></em></td>
      <td><div align="center">
        <input name="Tamin22" type="text" size="4" />
      </div></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td><em><strong>ĐBmax trung bình </strong></em></td>
      <td>&nbsp;</td>
      <td><div align="center">
        <input name="Tamax2" type="text" size="4" />
      </div></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td><strong>Tính tiên tiến của thiết bị Tb</strong> </td>
      <td><div align="center">Tbmin</div></td>
      <td><div align="center">Tbmax</div></td>
      <td>&nbsp;</td>
    </tr>
    <%
		RSBGC.open strBGC, conn
	...
	<tr>
	  <td><%=RSBGC("TenBuocGiaCong")%></td>
	  <td><div align="center">
	    <input name="Tamin3" type="text" size="4" />
	    </div></td>
	  <td><div align="center">
	    <input name="Tamax3" type="text" size="4" />
	    </div></td>
	  <td>Ghi chú 
	...
	%>
	  <tr>
	    <td><em><strong>Tbmin trung bình</strong> </em></td>
	    <td><div align="center">
	      <input name="Tamin32" type="text" size="4" />
	      </div></td>
	    <td>&nbsp;</td>
	    <td>&nbsp;</td>
	    </tr>
	  <tr>
      <td><em><strong>Tbmax trung bình </strong></em></td>
      <td>&nbsp;</td>
      <td><div align="center">
        <input name="Tamax32" type="text" size="4" />
      </div></td>
      <td>&nbsp;</td>
	</tr>
		<tr>
	  ...
	  <td colspan="2"><input type="reset" name="Submit2" value="Hủy bỏ" /></td>
    </tr>
  </table>
</form>
