          ...
          <td width="79%"><table width="100%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
              ...
              <td width="96%" valign="top"><!-- InstanceBeginEditable name="nhom_thietke" -->
                    <div align="left">				    
                      <p align="center" class="tex_de_muc"><strong>Thống kê thiết bị trong kho</strong></br>
                    </div>
                    <hr>
                <div align="Center">
                  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#F3F3F3" bgcolor="#F7F7F7">
  <tr>
    <td width="64" bgcolor="#E4E4E4"><div align="center">Số thứ tự</div></td>
    <td width="298" bgcolor="#E4E4E4"><div align="center">Tên thiết bị</div></td>
	 <td width="108" bgcolor="#E4E4E4"><div align="center">Số lượng Còn</div></td>
	 <td width="53" bgcolor="#E4E4E4"><div align="center">Sửa</div></td>
	 <td width="47" bgcolor="#E4E4E4"><div align="center">Xóa</div></td>
  </tr>
<%
	RS = oConn.Execute("SELECT ma_tb,ten_tb,so_luong_nhap,so_luong_xuat FROM PHIEU");
	var MaThietBi;
%>
<%
var i=1;
...
%>	
  <tr>
    ...
    <td bgcolor="#F7F7F7"><a href="DeviceDetai.asp?MaThietBi=<%=RS("ma_tb")%>"><%=RS("ten_tb")%></a></td>
	<td bgcolor="#F7F7F7">
	<%
		TongSoLuong = TongSoLuong + RS("so_luong_nhap")- RS("so_luong_xuat");
	%>
	<%=RS("so_luong_nhap")- RS("so_luong_xuat")%></td>
