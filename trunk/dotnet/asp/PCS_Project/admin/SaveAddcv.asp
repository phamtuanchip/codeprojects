...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="59"><a href="../default.asp" target="_top" onClick="MM_nbGroup('down','group1','menu_home','',1)" onMouseOver="MM_nbGroup('over','menu_home','images/menu_home_11.gif','',1)" onMouseOut="MM_nbGroup('out')"><img src="../images/menu_home_01.gif" alt="" name="menu_home" width="150" height="22" border="0" onload=""></a> <a href="admin.asp" target="_top" onClick="MM_nbGroup('down','group1','menu_lien_he','',0)" onMouseOver="MM_nbGroup('over','menu_lien_he','images/menu_lien_he_11.gif','',0)" onMouseOut="MM_nbGroup('out')"><img src="../images/admin.gif" alt="" name="menu_lien_he" width="150" height="22" border="0" onload=""></a></td>
    <td><p>&nbsp;</p>
        <p>&nbsp;</p></td>
  </tr>
</table>
            ...
            <tr>
              ...
              <td width="96%" valign="top"><!-- InstanceBeginEditable name="nhom_thietke" -->
				...
				%>
				    ...
				    <%				
					sql= "insert into CHUCVU (ten_chuc_vu) values"
					sql = sql + "(N'" + Request.Form("chucvu") + "')"; 
			
					
						
						oConn.Execute (sql);
				
						Response.Redirect("Addcv.asp");				
