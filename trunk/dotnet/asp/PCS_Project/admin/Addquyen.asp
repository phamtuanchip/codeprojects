...
%>
              <form action="SaveAddquyen.asp" method="post" name="Add_cv" id="Add_cv">
                <table width="266" border="1" align="center" cellspacing="0" class="Link">
                  <tr>
                    <td colspan="2"><div align="center" class="Folder">Th&ecirc;m quy&#7873;n</div></td>
                  </tr>
                  <tr>
                    <td width="128">Quy&#7873;n</td>
                    <td width="420"><input name="quyen_nv" type="text" id="quyen_nv">
                    </td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
