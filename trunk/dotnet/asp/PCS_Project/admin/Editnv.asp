          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
            <tr>
			  ...
			  if (!Session("login")) {
				...
				%>
              <%	
				RS = oConn.Execute("exec noi_3_bang " + Request.QueryString("manv"));
			  %>
              <form action="SaveEditnv.asp" method="post" name="edit" id="edit">
                <table rules="none" width="564" border="1" cellpadding="5" cellspacing="0" class="Link">
                  <tr bgcolor="#CCCCCC">
                    <td height="37" colspan="2"><div align="center" class="Folder">Sửa thông tin nhân viên</div></td>
                  </tr>
                  <tr>
                    <td width="144">Mã nhân viên</td>
                    <td width="388"><input name="manv" type="text" id="manv" value="<%=RS("ma_nv")%>" size="15"></td>
                  </tr>
                  <tr>
                    <td>Họ và tên</td>
                    <td><input name="tennv" type="text" id="tennv" value="<%=RS("ten_nv")%>">
                    </td>
                  </tr>
                  <tr>
                    <td>Chức vụ</td>
                    <td><select name="macv">
                        ...
                        <% RS1 = oConn.Execute("Select * from CHUCVU where ma_chuc_vu <>" + RS("ma_chuc_vu"));%>
                        <% while (!RS1.EOF) { %>
                  ...
                  <tr>
                    <td>Tên đăng nhập</td>
                    <td><input name="username" type="text" id="username" value="<%=RS("ten_dang_nhap")%>">
                    </td>
                  </tr>
                  <tr>
                    <td>Mât khẩu</td>
                    <td><input name="password" type="text" id="password" value="<%=RS("mat_khau")%>">
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td><select name="quyen_dn" id="quyen_dn">
                        ...
                        <% RS1 = oConn.Execute("Select * from QUYEN where quyen <>" + RS("quyen"));%>
                        <% while (!RS1.EOF) { %>
                        <option value="<%=RS1("quyen")%>"> <%=RS1("mota")%> </option>
                        <%
						  RS1.MoveNext }
						  %>
                    </select></td>
                  ...
                  <tr>
                    ...
                    <td><input name="dienthoai" type="text" id="dienthoai" value="<%=RS("dien_thoai_nv")%>">
                    </td>
                  </tr>
                  <tr>
                    <td height="35">Email</td>
                    <td height="35"><input name="email" type="text" id="email" value="<%=RS("email_nv")%>"></td>
                  </tr>
                  <tr>
                    <td height="35">Trạng thái</td>
                    <td height="35">Làm việc
                        <input name="trangthai" type="radio" value="Hiện đang làm việc" checked>
&nbsp;&nbsp;Ngh&#7881; làm
        <input name="trangthai" type="radio" value="Đã nghỉ làm"></td>
                  </tr>
                  <tr>
                    <td height="35" colspan="2"><div align="right">
                        <input name="sua" type="submit" id="sua" value="Sửa">
                        <input name="reset" type="reset" id="reset" value="Hủy bỏ">
                    </div></td>
                  </tr>
                </table>
              </form>
