...
<p>&nbsp;</p>     
	...
	rs.CursorLocation = 3;
	 //4 nhan vien 1 trang
	rs.PageSize = 10;
	rs.Open("select * from DICHVU", oConn);
...
%>
                ...
                <form name="form1" method="post" action="">
                  <table width="100%"  border="1" cellspacing="0" class="Link">
                    <tr>
                      <td colspan="6"><div align="center" class="Folder"> Danh mục loại dịch v&#7909;</div></td>
                    </tr>
                    <tr bgcolor="#CCCCCC">
                      <td width="7%"><div align="center">Stt</div></td>
                      <td width="35%"><div align="center">Loại dịch v&#7909;</div></td>
                      <td width="17%"><div align="center">K&yacute; hiệu</div></td>
                      <td width="22%"><div align="center">Gi&aacute; dịch v&#7909;</div></td>
                    ...
                    <tr>
                      ...
                      <td><div align="left"><a href="Services_details.asp?madv=<%=rs("ma_loai_dv")%>" class="ShowNext"> <%=rs("ten_loai_dv")%> </a></div></td>
                      <td><div align="center"> <%=rs("ky_hieu")%> </div></td>
                      <td><div align="center"> <%=rs("gia_dv")%> </div></td>
                      <td width="9%"><div align="center"><a href="Services_Edit.asp?madv=<%=rs("ma_loai_dv")%>" class="ShowNext">Sửa</a></div></td>
                      <td width="10%"><div align="center"><a href=javascript:del("<%=rs("ma_loai_dv")%>") class="ShowNext">Xóa</a></div></td>
                    </tr>
                    <%stt = stt +1;
					rs.MoveNext;} 
					%>
	...
	%>
                <p></p>
                <form name="viewFrm" method="get" action="Services.asp">
                  <p>
                    <input type="hidden" name="page" value="<%=rsCurrentPage%>"/>
                  </p>
                </form>
                <form action="Delete_Serv.asp" name="delFrm">
