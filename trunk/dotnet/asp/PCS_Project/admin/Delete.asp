...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
                  <td height="59"><a href="default.asp" target="_top" onClick="MM_nbGroup('down','group1','menu_home','',1)" onMouseOver="MM_nbGroup('over','menu_home','images/menu_home_11.gif','',1)" onMouseOut="MM_nbGroup('out')"><img src="images/menu_home_01.gif" alt="" name="menu_home" border="0" onload=""></a> 
                    <a href="lien_he.asp" target="_top" onClick="MM_nbGroup('down','group1','menu_lien_he','',0)" onMouseOver="MM_nbGroup('over','menu_lien_he','images/menu_lien_he_11.gif','',0)" onMouseOut="MM_nbGroup('out')"><img src="images/menu_lien_he_01.gif" alt="" name="menu_lien_he" border="0" onload=""></a><img src="images/admin.gif" alt="" name="menu_lien_he" width="150" height="22" border="0" onload=""></td>
    <td><p>&nbsp;</p>
        <p>&nbsp;</p></td>
  </tr>
</table>
...
<%			
	 oConn.Execute("DELETE from NHANVIEN where ma_nv='" + Request.QueryString("manv") + "'");
