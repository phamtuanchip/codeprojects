    ...
    <tr>
      <td width="301"><div align="center">
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="770" height="178">
          ...
          <embed src="images/logo.swf" width="770" height="178" loop="false" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"></embed>
        </object>
      </div></td>
    </tr>
  </table>
  ...
  <table width="770" height="211" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="2" background="images/bg01.gif"><table width="100%" height="57" border="0" cellpadding="0" cellspacing="0">
        <tr valign="top">
          <th width="200"><fieldset>
          <legend>&#272;&#259;ng nhập</legend>
          <br>
          <div align="center">
            <table width="150" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="36">T&ecirc;n</td>
                    <td width="100"><input name="textfield" type="text" class="inputtext" size="12" value="Tên" onfocus="if(this.value=='Tên')this.value='';"></td>
                    <td width="14">&nbsp;</td>
                  </tr>
                  <tr>
                    <td>M&atilde;</td>
                    <td><input name="textfield" type="password" class="inputtext" size="12" value="123456" onfocus="if(this.value=='123456')this.value='';"></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td height="19"><div align="right"> </div></td>
                    <td><div align="right">
                        <input name="login" type="submit" class="Buton" id="login" value="Đăng nhập">
                    </div></td>
                    <td>&nbsp;</td>
                  </tr>
                </table>
            ...
            <p><fieldset>
            <legend>Bảng chọn</legend>
<!-- InstanceBeginEditable name="nhom_menu" -->
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="59"><a href="default.asp" target="_top" onClick="MM_nbGroup('down','group1','menu_home','',1)" onMouseOver="MM_nbGroup('over','menu_home','images/menu_home_11.gif','',1)" onMouseOut="MM_nbGroup('out')"><img src="images/menu_home_01.gif" alt="" name="menu_home" border="0" onload=""></a> <a href="lien_he.asp" target="_top" onClick="MM_nbGroup('down','group1','menu_lien_he','',0)" onMouseOver="MM_nbGroup('over','menu_lien_he','images/menu_lien_he_11.gif','',0)" onMouseOut="MM_nbGroup('out')"><img src="images/menu_lien_he_01.gif" alt="" name="menu_lien_he" border="0" onload=""></a></td>
    <td><p>&nbsp;</p>
        <p>&nbsp;</p></td>
  </tr>
</table>
...
<p>&nbsp;</p>
          ...
          <td width="79%"><table width="98%" height="100%" border="0" cellpadding="00" cellspacing="0">
			...
			sql = sql + "ten_nv=N'" + Request.Form("tennv") + "',"
			sql = sql + "ma_chuc_vu='" + Request.Form("macv") + "',"
			sql = sql + "ten_dang_nhap='" + Request.Form("username") + "',"
			sql = sql + "mat_khau='" + Request.Form("password") + "',"
			sql = sql + "quyen='" + Request.Form("quyen_dn") + "',"
			sql = sql + "dien_thoai_nv='" + Request.Form("dienthoai") + "',"
			sql = sql + "email_nv='" + Request.Form("email") + "',"
			sql = sql + "trang_thai=N'" + Request.Form("trangthai") + "'"
			sql = sql + "where ma_nv='" +  Request.Form("manv") + "'";
