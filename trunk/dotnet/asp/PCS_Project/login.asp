...
-->
              ...
              <form name="login" method="post" action="login_result.asp">
                <table width="289" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="#0099CC" class="TitleSmall">
                  <tr bgcolor="#CCCCCC" background="image/hor_line.png">
                    <td colspan="2"><div align="center" class="Folder">Đăng nhập</div></td>
                  </tr>
                  <tr>
                    <td width="92" height="19"><span class="style2">Tên đăng nhập</span></td>
                    <td width="171" height="19"><div align="left">
                        <input name="username" type="text" class="BoxLink" id="username" size="25">
                    </div></td>
                  </tr>
                  <tr>
                    <td height="15"><span class="style2">Mật khẩu</span></td>
                    <td height="15"><input name="password" type="password" class="BoxLink" id="password" size="25"></td>
                  </tr>
                  <tr>
                    <td colspan="2"> 
                        <div align="right">
                          <input name="login" type="submit" class="VoteButton" id="login" value="Đăng nhập">
